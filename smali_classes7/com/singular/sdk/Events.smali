...
.method static constructor <clinit>()V
    ...
    const-string v2, "sng_rate"

    const-string v3, "sngRate"

    invoke-direct {v1, v3, v0, v2}, Lcom/singular/sdk/Events;-><init>(Ljava/lang/String;ILjava/lang/String;)V
    ...
    const-string v3, "sng_spent_credits"

    const-string v4, "sngSpentCredits"

    invoke-direct {v2, v4, v0, v3}, Lcom/singular/sdk/Events;-><init>(Ljava/lang/String;ILjava/lang/String;)V
    ...
    invoke-direct {v3, v5, v0, v4}, Lcom/singular/sdk/Events;-><init>(Ljava/lang/String;ILjava/lang/String;)V
    ...
    const-string v5, "sng_login"

    const-string v6, "sngLogin"

    invoke-direct {v4, v6, v0, v5}, Lcom/singular/sdk/Events;-><init>(Ljava/lang/String;ILjava/lang/String;)V
    ...
    const-string v6, "sng_start_trial"

    const-string v7, "sngStartTrial"

    invoke-direct {v5, v7, v0, v6}, Lcom/singular/sdk/Events;-><init>(Ljava/lang/String;ILjava/lang/String;)V
    ...
    const-string v7, "sng_subscribe"

    const-string v8, "sngSubscribe"

    invoke-direct {v6, v8, v0, v7}, Lcom/singular/sdk/Events;-><init>(Ljava/lang/String;ILjava/lang/String;)V
    ...
    const-string v8, "sng_book"

    const-string v9, "sngBook"

    invoke-direct {v7, v9, v0, v8}, Lcom/singular/sdk/Events;-><init>(Ljava/lang/String;ILjava/lang/String;)V
    ...
    const-string v9, "sng_content_view_list"

    const-string v10, "sngContentViewList"

    invoke-direct {v8, v10, v0, v9}, Lcom/singular/sdk/Events;-><init>(Ljava/lang/String;ILjava/lang/String;)V
    ...
    const-string v11, "sngInvite"

    invoke-direct {v9, v11, v0, v10}, Lcom/singular/sdk/Events;-><init>(Ljava/lang/String;ILjava/lang/String;)V
    ...
    const-string v11, "sng_share"

    const-string v12, "sngShare"

    invoke-direct {v10, v12, v0, v11}, Lcom/singular/sdk/Events;-><init>(Ljava/lang/String;ILjava/lang/String;)V
    ...
    const-string v12, "sng_submit_application"

    const-string v13, "sngSubmitApplication"

    invoke-direct {v11, v13, v0, v12}, Lcom/singular/sdk/Events;-><init>(Ljava/lang/String;ILjava/lang/String;)V
    ...
    const-string v13, "sng_update"

    const-string v14, "sngUpdate"

    invoke-direct {v12, v14, v0, v13}, Lcom/singular/sdk/Events;-><init>(Ljava/lang/String;ILjava/lang/String;)V
    ...
    const-string v14, "sng_ecommerce_purchase"

    const-string v15, "sngEcommercePurchase"

    invoke-direct {v13, v15, v0, v14}, Lcom/singular/sdk/Events;-><init>(Ljava/lang/String;ILjava/lang/String;)V
    ...
    invoke-direct {v14, v1, v0, v15}, Lcom/singular/sdk/Events;-><init>(Ljava/lang/String;ILjava/lang/String;)V

    sput-object v14, Lcom/singular/sdk/Events;->sngViewCart:Lcom/singular/sdk/Events;

    .line 18
    new-instance v15, Lcom/singular/sdk/Events;

    const/16 v0, 0xe

    const-string v1, "sng_achievement_unlocked"

    move-object/from16 v17, v2

    const-string v2, "sngAchievementUnlocked"

    invoke-direct {v15, v2, v0, v1}, Lcom/singular/sdk/Events;-><init>(Ljava/lang/String;ILjava/lang/String;)V

    sput-object v15, Lcom/singular/sdk/Events;->sngAchievementUnlocked:Lcom/singular/sdk/Events;
    ...
    const-string v3, "sng_add_to_cart"

    move-object/from16 v19, v0

    const-string v0, "sngAddToCart"

    invoke-direct {v1, v0, v2, v3}, Lcom/singular/sdk/Events;-><init>(Ljava/lang/String;ILjava/lang/String;)V

    sput-object v1, Lcom/singular/sdk/Events;->sngAddToCart:Lcom/singular/sdk/Events;
    ...
    const-string v3, "sng_add_to_wishlist"
    ...
    const-string v3, "sng_checkout_initiated"

    move-object/from16 v21, v0

    const-string v0, "sngCheckoutInitiated"

    invoke-direct {v1, v0, v2, v3}, Lcom/singular/sdk/Events;-><init>(Ljava/lang/String;ILjava/lang/String;)V

    sput-object v1, Lcom/singular/sdk/Events;->sngCheckoutInitiated:Lcom/singular/sdk/Events;
    ...
    const-string v3, "sng_complete_registration"
    ...
    const-string v3, "sng_content_view"

    move-object/from16 v23, v0

    const-string v0, "sngContentView"

    invoke-direct {v1, v0, v2, v3}, Lcom/singular/sdk/Events;-><init>(Ljava/lang/String;ILjava/lang/String;)V

    sput-object v1, Lcom/singular/sdk/Events;->sngContentView:Lcom/singular/sdk/Events;
    ...
    const-string v3, "sng_level_achieved"
    ...
    const-string v0, "sngSearch"

    invoke-direct {v1, v0, v2, v3}, Lcom/singular/sdk/Events;-><init>(Ljava/lang/String;ILjava/lang/String;)V

    sput-object v1, Lcom/singular/sdk/Events;->sngSearch:Lcom/singular/sdk/Events;
    ...
    .line 3
    filled-new-array/range {v1 .. v23}, [Lcom/singular/sdk/Events;
