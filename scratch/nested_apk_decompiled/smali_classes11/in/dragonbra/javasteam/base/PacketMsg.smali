...
.method public constructor <init>(Lin/dragonbra/javasteam/enums/EMsg;[B)V
    ...
    .line 33
    new-instance v0, Lin/dragonbra/javasteam/generated/MsgHdr;

    invoke-direct {v0}, Lin/dragonbra/javasteam/generated/MsgHdr;-><init>()V

    .line 35
    .local v0, "msgHdr":Lin/dragonbra/javasteam/generated/MsgHdr;
    ...
    :try_start_0
    invoke-virtual {v0, v1}, Lin/dragonbra/javasteam/generated/MsgHdr;->deserialize(Ljava/io/InputStream;)V
    :try_end_0
    ...
    invoke-virtual {v0}, Lin/dragonbra/javasteam/generated/MsgHdr;->getTargetJobID()J

    move-result-wide v1

    iput-wide v1, p0, Lin/dragonbra/javasteam/base/PacketMsg;->targetJobID:J

    .line 40
    invoke-virtual {v0}, Lin/dragonbra/javasteam/generated/MsgHdr;->getSourceJobID()J

    move-result-wide v1

    iput-wide v1, p0, Lin/dragonbra/javasteam/base/PacketMsg;->sourceJobID:J
