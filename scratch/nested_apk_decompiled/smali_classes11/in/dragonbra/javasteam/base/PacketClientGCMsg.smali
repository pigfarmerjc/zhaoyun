...
.method public constructor <init>(I[B)V
    ...
    .line 36
    new-instance v0, Lin/dragonbra/javasteam/generated/MsgGCHdr;

    invoke-direct {v0}, Lin/dragonbra/javasteam/generated/MsgGCHdr;-><init>()V

    .line 39
    .local v0, "gcHdr":Lin/dragonbra/javasteam/generated/MsgGCHdr;
    :try_start_0
    ...
    :try_start_1
    invoke-virtual {v0, v1}, Lin/dragonbra/javasteam/generated/MsgGCHdr;->deserialize(Ljava/io/InputStream;)V
    :try_end_1
    ...
    .end local v0    # "gcHdr":Lin/dragonbra/javasteam/generated/MsgGCHdr;
    .end local p1    # "eMsg":I
    .end local p2    # "data":[B
    :goto_0
    throw v2
    ...
    .line 41
    .end local v1    # "bais":Ljava/io/ByteArrayInputStream;
    .restart local v0    # "gcHdr":Lin/dragonbra/javasteam/generated/MsgGCHdr;
    ...
    invoke-virtual {v0}, Lin/dragonbra/javasteam/generated/MsgGCHdr;->getTargetJobID()J

    move-result-wide v2

    invoke-direct {v1, v2, v3}, Lin/dragonbra/javasteam/types/JobID;-><init>(J)V

    iput-object v1, p0, Lin/dragonbra/javasteam/base/PacketClientGCMsg;->targetJobID:Lin/dragonbra/javasteam/types/JobID;

    .line 45
    new-instance v1, Lin/dragonbra/javasteam/types/JobID;

    invoke-virtual {v0}, Lin/dragonbra/javasteam/generated/MsgGCHdr;->getSourceJobID()J

    move-result-wide v2

    invoke-direct {v1, v2, v3}, Lin/dragonbra/javasteam/types/JobID;-><init>(J)V

    iput-object v1, p0, Lin/dragonbra/javasteam/base/PacketClientGCMsg;->sourceJobID:Lin/dragonbra/javasteam/types/JobID;
