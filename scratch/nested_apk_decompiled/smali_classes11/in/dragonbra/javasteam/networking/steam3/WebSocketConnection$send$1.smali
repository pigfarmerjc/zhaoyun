...
# direct methods
.method constructor <init>([BLin/dragonbra/javasteam/networking/steam3/WebSocketConnection;Lkotlin/coroutines/Continuation;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([B",
...
.method public final create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    iget-object v2, p0, Lin/dragonbra/javasteam/networking/steam3/WebSocketConnection$send$1;->this$0:Lin/dragonbra/javasteam/networking/steam3/WebSocketConnection;

    invoke-direct {v0, v1, v2, p2}, Lin/dragonbra/javasteam/networking/steam3/WebSocketConnection$send$1;-><init>([BLin/dragonbra/javasteam/networking/steam3/WebSocketConnection;Lkotlin/coroutines/Continuation;)V
...
.method public final invoke(Lkotlinx/coroutines/CoroutineScope;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    check-cast v0, Lin/dragonbra/javasteam/networking/steam3/WebSocketConnection$send$1;

    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {v0, v1}, Lin/dragonbra/javasteam/networking/steam3/WebSocketConnection$send$1;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v2, p0, Lin/dragonbra/javasteam/networking/steam3/WebSocketConnection$send$1;->$data:[B

    const/4 v3, 0x1

    invoke-direct {v1, v3, v2}, Lio/ktor/websocket/Frame$Binary;-><init>(Z[B)V

    .line 129
    .local v1, "frame":Lio/ktor/websocket/Frame$Binary;
    iget-object v2, p0, Lin/dragonbra/javasteam/networking/steam3/WebSocketConnection$send$1;->this$0:Lin/dragonbra/javasteam/networking/steam3/WebSocketConnection;

    invoke-static {v2}, Lin/dragonbra/javasteam/networking/steam3/WebSocketConnection;->access$getSession$p(Lin/dragonbra/javasteam/networking/steam3/WebSocketConnection;)Lio/ktor/websocket/WebSocketSession;
    ...
    iput v3, p0, Lin/dragonbra/javasteam/networking/steam3/WebSocketConnection$send$1;->label:I

    invoke-interface {v2, v4, v5}, Lio/ktor/websocket/WebSocketSession;->send(Lio/ktor/websocket/Frame;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;

    move-result-object v2
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0

    .end local v1    # "frame":Lio/ktor/websocket/Frame$Binary;
    if-ne v2, v0, :cond_0
    ...
    const-string v2, "An error occurred while sending data"
