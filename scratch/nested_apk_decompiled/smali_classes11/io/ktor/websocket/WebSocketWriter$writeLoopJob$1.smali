...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v1, "$i$a$-useInstance-WebSocketWriter$writeLoopJob$1$1":I
    iget-object v2, p0, Lio/ktor/websocket/WebSocketWriter$writeLoopJob$1;->L$1:Ljava/lang/Object;

    .local v2, "instance$iv":Ljava/lang/Object;
    iget-object v3, p0, Lio/ktor/websocket/WebSocketWriter$writeLoopJob$1;->L$0:Ljava/lang/Object;
    ...
    .line 175
    .end local v1    # "$i$a$-useInstance-WebSocketWriter$writeLoopJob$1$1":I
    :catchall_0
    move-exception v1
    ...
    .line 38
    .end local v0    # "$i$f$useInstance":I
    ...
    invoke-virtual {v1}, Lio/ktor/websocket/WebSocketWriter;->getPool()Lio/ktor/utils/io/pool/ObjectPool;
    ...
    .local v5, "it":Ljava/nio/ByteBuffer;
    const/4 v6, 0x0

    .line 39
    .local v6, "$i$a$-useInstance-WebSocketWriter$writeLoopJob$1$1":I
    iput-object v3, p0, Lio/ktor/websocket/WebSocketWriter$writeLoopJob$1;->L$0:Ljava/lang/Object;

    iput-object v4, p0, Lio/ktor/websocket/WebSocketWriter$writeLoopJob$1;->L$1:Ljava/lang/Object;

    const/4 v7, 0x1

    iput v7, p0, Lio/ktor/websocket/WebSocketWriter$writeLoopJob$1;->label:I

    invoke-static {v1, v5, p0}, Lio/ktor/websocket/WebSocketWriter;->access$writeLoop(Lio/ktor/websocket/WebSocketWriter;Ljava/nio/ByteBuffer;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;

    move-result-object v1
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1

    .end local v5    # "it":Ljava/nio/ByteBuffer;
    if-ne v1, v0, :cond_0
    ...
    .end local v6    # "$i$a$-useInstance-WebSocketWriter$writeLoopJob$1$1":I
    .restart local v0    # "$i$f$useInstance":I
    .restart local v1    # "$i$a$-useInstance-WebSocketWriter$writeLoopJob$1$1":I
    .local v2, "instance$iv":Ljava/lang/Object;
    :goto_0
    :try_start_2
    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
