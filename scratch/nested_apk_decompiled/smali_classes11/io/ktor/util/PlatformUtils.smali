...
.method static constructor <clinit>()V
    ...
    .line 9
    .local v0, "platform":Lio/ktor/util/Platform;
    instance-of v1, v0, Lio/ktor/util/Platform$Js;
    ...
    sget-object v4, Lio/ktor/util/Platform$JsPlatform;->Browser:Lio/ktor/util/Platform$JsPlatform;
    ...
    .line 10
    :cond_1
    instance-of v1, v0, Lio/ktor/util/Platform$WasmJs;
    ...
    .line 8
    .end local v0    # "platform":Lio/ktor/util/Platform;
    :goto_0
    ...
    .line 14
    .restart local v0    # "platform":Lio/ktor/util/Platform;
    instance-of v1, v0, Lio/ktor/util/Platform$Js;
    ...
    sget-object v4, Lio/ktor/util/Platform$JsPlatform;->Node:Lio/ktor/util/Platform$JsPlatform;
    ...
    .end local v0    # "platform":Lio/ktor/util/Platform;
    :goto_1
    sput-boolean v2, Lio/ktor/util/PlatformUtils;->IS_NODE:Z
    ...
    instance-of v0, v0, Lio/ktor/util/Platform$Js;

    sput-boolean v0, Lio/ktor/util/PlatformUtils;->IS_JS:Z
    ...
    instance-of v0, v0, Lio/ktor/util/Platform$WasmJs;

    sput-boolean v0, Lio/ktor/util/PlatformUtils;->IS_WASM_JS:Z
    ...
    sget-object v1, Lio/ktor/util/Platform$Jvm;->INSTANCE:Lio/ktor/util/Platform$Jvm;
    ...
    sget-object v1, Lio/ktor/util/Platform$Native;->INSTANCE:Lio/ktor/util/Platform$Native;

    invoke-static {v0, v1}, Lkotlin/jvm/internal/Intrinsics;->areEqual(Ljava/lang/Object;Ljava/lang/Object;)Z

    move-result v0

    sput-boolean v0, Lio/ktor/util/PlatformUtils;->IS_NATIVE:Z
