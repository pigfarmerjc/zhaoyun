...
# direct methods
.method public static synthetic $r8$lambda$5viiriCzCG9w0mvsiLbwcP40VyM(Lio/ktor/network/sockets/SocketOptions$UDPSocketOptions;)Lkotlin/Unit;
    .locals 0

    invoke-static {p0}, Lio/ktor/network/sockets/UDPSocketBuilder;->connect$lambda$1(Lio/ktor/network/sockets/SocketOptions$UDPSocketOptions;)Lkotlin/Unit;
...
.method public static synthetic bind$default(Lio/ktor/network/sockets/UDPSocketBuilder;Lio/ktor/network/sockets/SocketAddress;Lkotlin/jvm/functions/Function1;Lkotlin/coroutines/Continuation;ILjava/lang/Object;)Ljava/lang/Object;
    ...
    .line 21
    new-instance p2, Lio/ktor/network/sockets/UDPSocketBuilder$$ExternalSyntheticLambda0;

    invoke-direct {p2}, Lio/ktor/network/sockets/UDPSocketBuilder$$ExternalSyntheticLambda0;-><init>()V
...
.method private static final bind$lambda$0(Lio/ktor/network/sockets/SocketOptions$UDPSocketOptions;)Lkotlin/Unit;
    .locals 1
    .param p0, "<this>"    # Lio/ktor/network/sockets/SocketOptions$UDPSocketOptions;
...
.method public static synthetic connect$default(Lio/ktor/network/sockets/UDPSocketBuilder;Lio/ktor/network/sockets/SocketAddress;Lio/ktor/network/sockets/SocketAddress;Lkotlin/jvm/functions/Function1;Lkotlin/coroutines/Continuation;ILjava/lang/Object;)Ljava/lang/Object;
    ...
    .line 30
    new-instance p3, Lio/ktor/network/sockets/UDPSocketBuilder$$ExternalSyntheticLambda1;

    invoke-direct {p3}, Lio/ktor/network/sockets/UDPSocketBuilder$$ExternalSyntheticLambda1;-><init>()V
...
.method private static final connect$lambda$1(Lio/ktor/network/sockets/SocketOptions$UDPSocketOptions;)Lkotlin/Unit;
    .locals 1
    .param p0, "<this>"    # Lio/ktor/network/sockets/SocketOptions$UDPSocketOptions;
...
.method public final bind(Lio/ktor/network/sockets/SocketAddress;Lkotlin/jvm/functions/Function1;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-static {v0, p1, v1}, Lio/ktor/network/sockets/UDPSocketBuilderJvmKt;->bindUDP(Lio/ktor/network/selector/SelectorManager;Lio/ktor/network/sockets/SocketAddress;Lio/ktor/network/sockets/SocketOptions$UDPSocketOptions;)Lio/ktor/network/sockets/BoundDatagramSocket;
...
.method public final connect(Lio/ktor/network/sockets/SocketAddress;Lio/ktor/network/sockets/SocketAddress;Lkotlin/jvm/functions/Function1;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-static {v0, p1, p2, v1}, Lio/ktor/network/sockets/UDPSocketBuilderJvmKt;->connectUDP(Lio/ktor/network/selector/SelectorManager;Lio/ktor/network/sockets/SocketAddress;Lio/ktor/network/sockets/SocketAddress;Lio/ktor/network/sockets/SocketOptions$UDPSocketOptions;)Lio/ktor/network/sockets/ConnectedDatagramSocket;
