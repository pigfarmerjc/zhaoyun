...
.method public static final isEmpty(Lkotlinx/io/Buffer;)Z
    .locals 4
    .param p0, "$this$isEmpty"    # Lkotlinx/io/Buffer;
...
.method public static final readBytes(Lkotlinx/io/Buffer;I)[B
    .locals 1
    .param p0, "$this$readBytes"    # Lkotlinx/io/Buffer;
    .param p1, "count"    # I
    ...
    invoke-static {v0, p1}, Lkotlinx/io/SourcesKt;->readByteArray(Lkotlinx/io/Source;I)[B
