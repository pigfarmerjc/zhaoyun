...
.method public static final SocketTimeoutException(Ljava/lang/String;Ljava/lang/Throwable;)Ljava/net/SocketTimeoutException;
    ...
    .line 28
    .local v1, "$this$SocketTimeoutException_u24lambda_u240":Ljava/net/SocketTimeoutException;
    const/4 v2, 0x0

    .line 26
    .local v2, "$i$a$-apply-TimeoutExceptionsKt$SocketTimeoutException$1":I
    invoke-virtual {v1, p1}, Ljava/net/SocketTimeoutException;->initCause(Ljava/lang/Throwable;)Ljava/lang/Throwable;

    .end local v1    # "$this$SocketTimeoutException_u24lambda_u240":Ljava/net/SocketTimeoutException;
    .end local v2    # "$i$a$-apply-TimeoutExceptionsKt$SocketTimeoutException$1":I
    return-object v0
.end method
