...
.method public constructor <init>(Lio/ktor/client/HttpClient;Lio/ktor/client/request/HttpRequest;Lio/ktor/client/statement/HttpResponse;[B)V
    ...
    invoke-direct {v0, p0, p2}, Lio/ktor/client/call/SavedHttpRequest;-><init>(Lio/ktor/client/call/SavedHttpCall;Lio/ktor/client/request/HttpRequest;)V

    check-cast v0, Lio/ktor/client/request/HttpRequest;

    invoke-virtual {p0, v0}, Lio/ktor/client/call/SavedHttpCall;->setRequest(Lio/ktor/client/request/HttpRequest;)V

    .line 46
    new-instance v0, Lio/ktor/client/call/SavedHttpResponse;

    iget-object v1, p0, Lio/ktor/client/call/SavedHttpCall;->responseBody:[B

    invoke-direct {v0, p0, v1, p3}, Lio/ktor/client/call/SavedHttpResponse;-><init>(Lio/ktor/client/call/SavedHttpCall;[BLio/ktor/client/statement/HttpResponse;)V

    check-cast v0, Lio/ktor/client/statement/HttpResponse;

    invoke-virtual {p0, v0}, Lio/ktor/client/call/SavedHttpCall;->setResponse(Lio/ktor/client/statement/HttpResponse;)V
    ...
    invoke-static {v0, v1, v2, v3}, Lio/ktor/client/call/UtilsKt;->checkContentLength(Ljava/lang/Long;JLio/ktor/http/HttpMethod;)V
    ...
    iput-boolean v0, p0, Lio/ktor/client/call/SavedHttpCall;->allowDoubleReceive:Z
...
.method protected getResponseContent(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .line 55
    iget-object v0, p0, Lio/ktor/client/call/SavedHttpCall;->responseBody:[B
