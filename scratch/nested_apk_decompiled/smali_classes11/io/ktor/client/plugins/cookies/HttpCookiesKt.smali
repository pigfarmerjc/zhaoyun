...
.method public static final cookies(Lio/ktor/client/HttpClient;Lio/ktor/http/Url;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    :goto_0
    iget-object v1, v0, Lio/ktor/client/plugins/cookies/HttpCookiesKt$cookies$1;->result:Ljava/lang/Object;
    ...
    .line 136
    iget v3, v0, Lio/ktor/client/plugins/cookies/HttpCookiesKt$cookies$1;->label:I
    ...
    .local p0, "$this$cookies":Lio/ktor/client/HttpClient;
    .local p1, "url":Lio/ktor/http/Url;
    sget-object v3, Lio/ktor/client/plugins/cookies/HttpCookies;->Companion:Lio/ktor/client/plugins/cookies/HttpCookies$Companion;

    check-cast v3, Lio/ktor/client/plugins/HttpClientPlugin;

    invoke-static {p0, v3}, Lio/ktor/client/plugins/HttpClientPluginKt;->pluginOrNull(Lio/ktor/client/HttpClient;Lio/ktor/client/plugins/HttpClientPlugin;)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Lio/ktor/client/plugins/cookies/HttpCookies;

    .end local p0    # "$this$cookies":Lio/ktor/client/HttpClient;
    if-eqz v3, :cond_2

    const/4 p0, 0x1

    iput p0, v0, Lio/ktor/client/plugins/cookies/HttpCookiesKt$cookies$1;->label:I

    invoke-virtual {v3, p1, v0}, Lio/ktor/client/plugins/cookies/HttpCookies;->get(Lio/ktor/http/Url;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
...
.method public static final cookies(Lio/ktor/client/HttpClient;Ljava/lang/String;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .local v0, "$continuation":Lkotlin/coroutines/Continuation;
    :goto_0
    iget-object v1, v0, Lio/ktor/client/plugins/cookies/HttpCookiesKt$cookies$2;->result:Ljava/lang/Object;
    ...
    .line 141
    iget v3, v0, Lio/ktor/client/plugins/cookies/HttpCookiesKt$cookies$2;->label:I
    ...
    .line 142
    .local p0, "$this$cookies":Lio/ktor/client/HttpClient;
    .local p1, "urlString":Ljava/lang/String;
    sget-object v3, Lio/ktor/client/plugins/cookies/HttpCookies;->Companion:Lio/ktor/client/plugins/cookies/HttpCookies$Companion;
    ...
    iput v4, v0, Lio/ktor/client/plugins/cookies/HttpCookiesKt$cookies$2;->label:I

    invoke-virtual {v3, p0, v0}, Lio/ktor/client/plugins/cookies/HttpCookies;->get(Lio/ktor/http/Url;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
...
.method public static final get(Ljava/util/List;Ljava/lang/String;)Lio/ktor/http/Cookie;
    ...
    .line 149
    .local v2, "it":Lio/ktor/http/Cookie;
    const/4 v3, 0x0

    .line 147
    .local v3, "$i$a$-find-HttpCookiesKt$get$1":I
    invoke-virtual {v2}, Lio/ktor/http/Cookie;->getName()Ljava/lang/String;
    ...
    .end local v2    # "it":Lio/ktor/http/Cookie;
    .end local v3    # "$i$a$-find-HttpCookiesKt$get$1":I
    if-eqz v2, :cond_0
...
.method private static final renderClientCookies(Ljava/util/List;)Ljava/lang/String;
    ...
    sget-object v2, Lio/ktor/client/plugins/cookies/HttpCookiesKt$renderClientCookies$1;->INSTANCE:Lio/ktor/client/plugins/cookies/HttpCookiesKt$renderClientCookies$1;
