...
.method public final create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    new-instance v0, Lio/ktor/client/engine/cio/Endpoint$timeout$1;

    iget-object v1, p0, Lio/ktor/client/engine/cio/Endpoint$timeout$1;->this$0:Lio/ktor/client/engine/cio/Endpoint;

    invoke-direct {v0, v1, p2}, Lio/ktor/client/engine/cio/Endpoint$timeout$1;-><init>(Lio/ktor/client/engine/cio/Endpoint;Lkotlin/coroutines/Continuation;)V
...
.method public final invoke(Lkotlinx/coroutines/CoroutineScope;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    check-cast v0, Lio/ktor/client/engine/cio/Endpoint$timeout$1;

    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {v0, v1}, Lio/ktor/client/engine/cio/Endpoint$timeout$1;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .end local p0    # "this":Lio/ktor/client/engine/cio/Endpoint$timeout$1;
    ...
    .restart local p0    # "this":Lio/ktor/client/engine/cio/Endpoint$timeout$1;
    ...
    .line 43
    .end local p0    # "this":Lio/ktor/client/engine/cio/Endpoint$timeout$1;
    .local v1, "this":Lio/ktor/client/engine/cio/Endpoint$timeout$1;
    :goto_0
    nop

    .line 44
    :try_start_1
    iget-object v4, v1, Lio/ktor/client/engine/cio/Endpoint$timeout$1;->this$0:Lio/ktor/client/engine/cio/Endpoint;

    iget-wide v4, v4, Lio/ktor/client/engine/cio/Endpoint;->lastActivity:J

    iget-object v6, v1, Lio/ktor/client/engine/cio/Endpoint$timeout$1;->this$0:Lio/ktor/client/engine/cio/Endpoint;

    invoke-static {v6}, Lio/ktor/client/engine/cio/Endpoint;->access$getMaxEndpointIdleTime$p(Lio/ktor/client/engine/cio/Endpoint;)J
    ...
    iput v2, v1, Lio/ktor/client/engine/cio/Endpoint$timeout$1;->label:I
    ...
    .line 53
    :goto_2
    iget-object v0, v1, Lio/ktor/client/engine/cio/Endpoint$timeout$1;->this$0:Lio/ktor/client/engine/cio/Endpoint;

    invoke-static {v0}, Lio/ktor/client/engine/cio/Endpoint;->access$getDeliveryPoint$p(Lio/ktor/client/engine/cio/Endpoint;)Lkotlinx/coroutines/channels/Channel;
    ...
    invoke-static {v0}, Lio/ktor/client/engine/cio/Endpoint;->access$getOnDone$p(Lio/ktor/client/engine/cio/Endpoint;)Lkotlin/jvm/functions/Function0;
