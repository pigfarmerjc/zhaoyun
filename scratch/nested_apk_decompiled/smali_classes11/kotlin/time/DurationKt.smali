...
.method private static final parseDuration(Ljava/lang/String;Z)J
    ...
    .local v13, "$this$substringWhile$iv":Ljava/lang/String;
    const/16 v16, 0x0
    ...
    .local v17, "infinityString":Ljava/lang/String;
    .local v18, "length":I
    .local v27, "nonDigitSymbols":Ljava/lang/String;
    invoke-static {v15, v14, v7, v10, v2}, Lkotlin/text/StringsKt;->contains$default(Ljava/lang/CharSequence;CZILjava/lang/Object;)Z
    ...
    .end local v17    # "infinityString":Ljava/lang/String;
    ...
    .end local v7    # "length":I
    .end local v10    # "infinityString":Ljava/lang/String;
    .restart local v17    # "infinityString":Ljava/lang/String;
    ...
    invoke-virtual {v13, v12, v5}, Ljava/lang/String;->substring(II)Ljava/lang/String;
    ...
    .end local v13    # "$this$substringWhile$iv":Ljava/lang/String;
    ...
    .line 935
    invoke-static {v7, v3}, Lkotlin/time/DurationUnitKt;->durationUnitByIsoChar(CZ)Lkotlin/time/DurationUnit;
    ...
    invoke-virtual {v13, v14}, Lkotlin/time/DurationUnit;->compareTo(Ljava/lang/Enum;)I
    ...
    .local v15, "isTimeComponent":Z
    invoke-static {v14}, Lkotlin/time/DurationKt;->parseOverLongIsoComponent(Ljava/lang/String;)J

    move-result-wide v2

    invoke-static {v2, v3, v12}, Lkotlin/time/DurationKt;->toDuration(JLkotlin/time/DurationUnit;)J
    ...
    invoke-static {v8, v9, v12}, Lkotlin/time/DurationKt;->toDuration(DLkotlin/time/DurationUnit;)J
    ...
    .line 939
    .end local v15    # "isTimeComponent":Z
    .restart local v3    # "isTimeComponent":Z
    :cond_d
    move v15, v3

    .line 944
    .end local v3    # "isTimeComponent":Z
    .restart local v15    # "isTimeComponent":Z
    ...
    const-string v4, "Missing unit for value "
    ...
    .restart local v3    # "startIndex$iv":I
    move-object/from16 v4, p0
    ...
    .line 970
    .local v23, "$i$a$-substringWhile-DurationKt$parseDuration$unitName$1":I
    const/16 v6, 0x61
    ...
    .line 1083
    .end local v5    # "it":C
    .end local v23    # "$i$a$-substringWhile-DurationKt$parseDuration$unitName$1":I
    :goto_16
    if-eqz v5, :cond_23
