...
.method public constructor <init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Z)V
    ...
    :cond_1
    const-string p6, "org.bouncycastle.ec.fp_max_size"

    const/16 v0, 0x412

    invoke-static {p6, v0}, Lorg/bouncycastle/util/Properties;->asInteger(Ljava/lang/String;I)I

    move-result p6

    const-string v0, "org.bouncycastle.ec.fp_certainty"
    ...
    invoke-static {v1, v0}, Lorg/bouncycastle/math/ec/ECCurve;->access$000(II)I

    move-result v0

    invoke-static {p1, p6, v0}, Lorg/bouncycastle/math/Primes;->isMRProbablePrime(Ljava/math/BigInteger;Ljava/security/SecureRandom;I)Z
