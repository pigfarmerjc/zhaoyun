...
.method private decodeLastBlock(Ljava/io/OutputStream;CCCCCCCC)I
    ...
    iget-byte p9, p0, Lorg/bouncycastle/util/encoders/Base32Encoder;->padding:B
    ...
    :cond_1
    iget-byte p8, p0, Lorg/bouncycastle/util/encoders/Base32Encoder;->padding:B

    if-ne p7, p8, :cond_8

    iget-byte p7, p0, Lorg/bouncycastle/util/encoders/Base32Encoder;->padding:B
    ...
    :cond_3
    iget-byte p6, p0, Lorg/bouncycastle/util/encoders/Base32Encoder;->padding:B
    ...
    :cond_5
    iget-byte p5, p0, Lorg/bouncycastle/util/encoders/Base32Encoder;->padding:B
...
.method private encodeBlock([BI[BI)V
    ...
    iget-object v3, p0, Lorg/bouncycastle/util/encoders/Base32Encoder;->encodingTable:[B
...
.method public encode([BII[BI)I
    ...
    invoke-direct {p0, p1, v1, p4, v2}, Lorg/bouncycastle/util/encoders/Base32Encoder;->encodeBlock([BI[BI)V
    ...
    invoke-direct {p0, p2, v0, p4, v2}, Lorg/bouncycastle/util/encoders/Base32Encoder;->encodeBlock([BI[BI)V
