...
.method public engineDoFinal([BII)[B
    ...
    :try_start_0
    iget p3, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/IESCipher;->state:I
    ...
    invoke-virtual {p3, v3, v0, v2, p2}, Lorg/bouncycastle/crypto/engines/IESEngine;->init(ZLorg/bouncycastle/crypto/CipherParameters;Lorg/bouncycastle/crypto/CipherParameters;Lorg/bouncycastle/crypto/CipherParameters;)V
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/IESCipher;->otherKeyParameter:Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;
    ...
    invoke-virtual {p3, v2, v0, v4, p2}, Lorg/bouncycastle/crypto/engines/IESEngine;->init(ZLorg/bouncycastle/crypto/CipherParameters;Lorg/bouncycastle/crypto/CipherParameters;Lorg/bouncycastle/crypto/CipherParameters;)V
    ...
    instance-of p3, p3, Lorg/bouncycastle/crypto/params/X25519PrivateKeyParameters;
    ...
    iget v2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/IESCipher;->state:I
    ...
    :cond_8
    iget v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/IESCipher;->state:I
    ...
    new-instance v4, Lorg/bouncycastle/crypto/parsers/XIESPublicKeyParser;

    invoke-direct {v4, p3}, Lorg/bouncycastle/crypto/parsers/XIESPublicKeyParser;-><init>(Z)V

    invoke-virtual {v0, v2, p2, v4}, Lorg/bouncycastle/crypto/engines/IESEngine;->init(Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;Lorg/bouncycastle/crypto/CipherParameters;Lorg/bouncycastle/crypto/KeyParser;)V
    ...
    iget-object v5, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/IESCipher;->random:Ljava/security/SecureRandom;

    invoke-direct {v2, v5, v4}, Lorg/bouncycastle/crypto/KeyGenerationParameters;-><init>(Ljava/security/SecureRandom;I)V

    invoke-interface {v0, v2}, Lorg/bouncycastle/crypto/AsymmetricCipherKeyPairGenerator;->init(Lorg/bouncycastle/crypto/KeyGenerationParameters;)V

    new-instance v2, Lorg/bouncycastle/crypto/generators/EphemeralKeyPairGenerator;

    new-instance v4, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/IESCipher$1;

    invoke-direct {v4, p0, p3}, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/IESCipher$1;-><init>(Lorg/bouncycastle/jcajce/provider/asymmetric/edec/IESCipher;Z)V

    invoke-direct {v2, v0, v4}, Lorg/bouncycastle/crypto/generators/EphemeralKeyPairGenerator;-><init>(Lorg/bouncycastle/crypto/AsymmetricCipherKeyPairGenerator;Lorg/bouncycastle/crypto/KeyEncoder;)V
    ...
    invoke-virtual {p3, v0, p2, v2}, Lorg/bouncycastle/crypto/engines/IESEngine;->init(Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;Lorg/bouncycastle/crypto/CipherParameters;Lorg/bouncycastle/crypto/generators/EphemeralKeyPairGenerator;)V
