...
.method public constructor <init>(IIIIII)V
    ...
    iget p2, p0, Lorg/bouncycastle/pqc/crypto/bike/BIKEEngine;->w:I
...
.method private BFIter([B[BI[I[I[I[I[B[B[B)V
    ...
    iget v4, v6, Lorg/bouncycastle/pqc/crypto/bike/BIKEEngine;->r:I
...
.method private recomputeSyndrome([BI[I[IZ)V
    ...
    :cond_0
    iget p4, p0, Lorg/bouncycastle/pqc/crypto/bike/BIKEEngine;->r:I
...
.method public decaps([B[B[B[B[B[B)V
    ...
    invoke-direct {p0, v1, p3}, Lorg/bouncycastle/pqc/crypto/bike/BIKEEngine;->convertToCompact([I[B)V

    invoke-direct {p0, p5, p2}, Lorg/bouncycastle/pqc/crypto/bike/BIKEEngine;->computeSyndrome([B[B)[B

    move-result-object p2

    invoke-direct {p0, p2, v0, v1}, Lorg/bouncycastle/pqc/crypto/bike/BIKEEngine;->BGFDecoder([B[I[I)[B
    ...
    invoke-direct {p0, v0, p2, p3}, Lorg/bouncycastle/pqc/crypto/bike/BIKEEngine;->splitEBytes([B[B[B)V

    iget v1, p0, Lorg/bouncycastle/pqc/crypto/bike/BIKEEngine;->L_BYTE:I

    new-array v6, v1, [B

    invoke-direct {p0, p2, p3, v6}, Lorg/bouncycastle/pqc/crypto/bike/BIKEEngine;->functionL([B[B[B)V
...
.method public encaps([B[B[B[BLjava/security/SecureRandom;)V
    ...
    invoke-direct {p0, p5, v1, v2}, Lorg/bouncycastle/pqc/crypto/bike/BIKEEngine;->splitEBytes([B[B[B)V
    ...
    invoke-virtual {v4, v1, p5}, Lorg/bouncycastle/pqc/crypto/bike/BIKERing;->decodeBytes([B[J)V

    iget-object v4, p0, Lorg/bouncycastle/pqc/crypto/bike/BIKEEngine;->bikeRing:Lorg/bouncycastle/pqc/crypto/bike/BIKERing;

    invoke-virtual {v4, v2, v3}, Lorg/bouncycastle/pqc/crypto/bike/BIKERing;->decodeBytes([B[J)V
    ...
    invoke-direct {p0, v1, v2, p2}, Lorg/bouncycastle/pqc/crypto/bike/BIKEEngine;->functionL([B[B[B)V
