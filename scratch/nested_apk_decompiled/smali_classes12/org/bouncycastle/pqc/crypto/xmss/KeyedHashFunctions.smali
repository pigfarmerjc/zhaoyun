...
.method private coreDigest(I[B[B)[B
    ...
    iget-object p2, p0, Lorg/bouncycastle/pqc/crypto/xmss/KeyedHashFunctions;->digest:Lorg/bouncycastle/crypto/Digest;

    instance-of p2, p2, Lorg/bouncycastle/crypto/Xof;

    if-eqz p2, :cond_0

    iget-object p2, p0, Lorg/bouncycastle/pqc/crypto/xmss/KeyedHashFunctions;->digest:Lorg/bouncycastle/crypto/Digest;

    check-cast p2, Lorg/bouncycastle/crypto/Xof;
    ...
    invoke-interface {p2, p1, v2}, Lorg/bouncycastle/crypto/Digest;->doFinal([BI)I
