...
.method public constructor <init>(III[IZI)V
    ...
    iput p1, p0, Lorg/bouncycastle/pqc/crypto/cmce/CMCEEngine;->IRR_BYTES:I
    ...
    iget p3, p0, Lorg/bouncycastle/pqc/crypto/cmce/CMCEEngine;->GFBITS:I
    ...
    iput p1, p0, Lorg/bouncycastle/pqc/crypto/cmce/CMCEEngine;->COND_BYTES:I
    ...
    iput p1, p0, Lorg/bouncycastle/pqc/crypto/cmce/CMCEEngine;->PK_NROWS:I

    iget p1, p0, Lorg/bouncycastle/pqc/crypto/cmce/CMCEEngine;->SYS_N:I

    iget p3, p0, Lorg/bouncycastle/pqc/crypto/cmce/CMCEEngine;->PK_NROWS:I

    sub-int/2addr p1, p3

    iput p1, p0, Lorg/bouncycastle/pqc/crypto/cmce/CMCEEngine;->PK_NCOLS:I

    iget p1, p0, Lorg/bouncycastle/pqc/crypto/cmce/CMCEEngine;->PK_NCOLS:I

    add-int/lit8 p1, p1, 0x7

    div-int/lit8 p1, p1, 0x8

    iput p1, p0, Lorg/bouncycastle/pqc/crypto/cmce/CMCEEngine;->PK_ROW_BYTES:I

    iget p1, p0, Lorg/bouncycastle/pqc/crypto/cmce/CMCEEngine;->PK_NROWS:I

    add-int/lit8 p1, p1, 0x7

    div-int/lit8 p1, p1, 0x8

    iput p1, p0, Lorg/bouncycastle/pqc/crypto/cmce/CMCEEngine;->SYND_BYTES:I
    ...
    iput p1, p0, Lorg/bouncycastle/pqc/crypto/cmce/CMCEEngine;->GFMASK:I
    ...
    iget p4, p0, Lorg/bouncycastle/pqc/crypto/cmce/CMCEEngine;->SYS_T:I

    iget p5, p0, Lorg/bouncycastle/pqc/crypto/cmce/CMCEEngine;->GFBITS:I

    invoke-direct {p1, p3, p4, p5}, Lorg/bouncycastle/pqc/crypto/cmce/BENES12;-><init>(III)V
    ...
    invoke-direct {p1, p3, p4, p5}, Lorg/bouncycastle/pqc/crypto/cmce/BENES13;-><init>(III)V
    ...
    iget p4, p0, Lorg/bouncycastle/pqc/crypto/cmce/CMCEEngine;->SYS_N:I
    ...
    :goto_2
    iput-boolean p2, p0, Lorg/bouncycastle/pqc/crypto/cmce/CMCEEngine;->countErrorIndices:Z
...
.method private bm([S[S)V
    ...
    aget-short v13, v4, v10

    and-int/2addr v13, v5

    aget-short v14, v1, v10
...
.method private decrypt([B[B[B)I
    ...
    :cond_0
    iget p3, p0, Lorg/bouncycastle/pqc/crypto/cmce/CMCEEngine;->SYND_BYTES:I
    ...
    invoke-virtual {p3, v2, p2}, Lorg/bouncycastle/pqc/crypto/cmce/BENES;->support_gen([S[B)V

    invoke-direct {p0, v3, v0, v2, v7}, Lorg/bouncycastle/pqc/crypto/cmce/CMCEEngine;->synd([S[S[S[B)V

    invoke-direct {p0, v5, v3}, Lorg/bouncycastle/pqc/crypto/cmce/CMCEEngine;->bm([S[S)V

    invoke-direct {p0, v6, v5, v2}, Lorg/bouncycastle/pqc/crypto/cmce/CMCEEngine;->root([S[S[S)V
    ...
    invoke-virtual {v5, v7}, Lorg/bouncycastle/pqc/crypto/cmce/GF;->gf_iszero(S)S
    ...
    :cond_4
    invoke-direct {p0, v4, v0, v2, p1}, Lorg/bouncycastle/pqc/crypto/cmce/CMCEEngine;->synd([S[S[S[B)V
...
.method private mov_columns([[B[S[J)I
    ...
    invoke-static {v1, v14}, Lorg/bouncycastle/pqc/crypto/cmce/CMCEEngine;->same_mask64(SS)J

    move-result-wide v14

    and-long/2addr v11, v14

    aget-short v1, p2, v10
...
.method private pk_gen([B[B[I[S[J)I
    ...
    :cond_1
    invoke-static {v7, v5, v6}, Lorg/bouncycastle/pqc/crypto/cmce/CMCEEngine;->sort64([JII)V
    ...
    invoke-direct {v0, v7, v3, v6}, Lorg/bouncycastle/pqc/crypto/cmce/CMCEEngine;->root([S[S[S)V
    ...
    iget-boolean v10, v0, Lorg/bouncycastle/pqc/crypto/cmce/CMCEEngine;->usePivots:Z
    ...
    invoke-direct {v0, v3, v2, v10}, Lorg/bouncycastle/pqc/crypto/cmce/CMCEEngine;->mov_columns([[B[S[J)I
    ...
    invoke-static {v4, v6, v1, v7, v2}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
...
.method private synd([S[S[S[B)V
    ...
    invoke-virtual {v7, v5}, Lorg/bouncycastle/pqc/crypto/cmce/GF;->gf_sq(S)S
...
.method public decompress_private_key([B)[B
    ...
    invoke-interface {v3, v0, v8, v2}, Lorg/bouncycastle/crypto/Xof;->update([BII)V
    ...
    iget v12, v6, Lorg/bouncycastle/pqc/crypto/cmce/CMCEEngine;->IRR_BYTES:I
    ...
    invoke-static {v4, v12, v13}, Lorg/bouncycastle/pqc/crypto/cmce/Utils;->store_gf([BIS)V
    ...
    invoke-static {v4, v8, v7, v11, v3}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
    ...
    iget v0, v6, Lorg/bouncycastle/pqc/crypto/cmce/CMCEEngine;->IRR_BYTES:I
...
.method public generate_public_key_from_private_key([B)[B
    ...
    invoke-interface {v9, v10}, Lorg/bouncycastle/crypto/Xof;->update(B)V

    const/16 v10, 0x20

    invoke-interface {v9, p1, v1, v10}, Lorg/bouncycastle/crypto/Xof;->update([BII)V

    invoke-interface {v9, v7, v1, v3}, Lorg/bouncycastle/crypto/Xof;->doFinal([BII)I
...
.method public kem_dec([B[B[B)I
    ...
    invoke-interface {p2, v2, v4, v1}, Lorg/bouncycastle/crypto/Xof;->update([BII)V
...
.method public kem_keypair([B[BLjava/security/SecureRandom;)V
    ...
    :goto_0
    invoke-interface {v15, v10, v11, v9}, Lorg/bouncycastle/crypto/Xof;->update([BII)V

    array-length v2, v0

    invoke-interface {v15, v0, v11, v2}, Lorg/bouncycastle/crypto/Xof;->update([BII)V
    ...
    invoke-static {v5, v11, v8}, Lorg/bouncycastle/util/Arrays;->copyOfRange([BII)[B
    ...
    invoke-static {v13, v0, v7, v1, v2}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
