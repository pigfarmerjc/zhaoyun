...
.method public isap_mac([BI[BI[BI)V
    ...
    iget-object v7, p0, Lorg/bouncycastle/crypto/engines/ISAPEngine$ISAPAEAD_K;->E:[S
    ...
    invoke-virtual/range {v3 .. v8}, Lorg/bouncycastle/crypto/engines/ISAPEngine$ISAPAEAD_K;->ABSORB_MAC([S[BI[S[S)V
    ...
    iget-object v5, p0, Lorg/bouncycastle/crypto/engines/ISAPEngine$ISAPAEAD_K;->E:[S
    ...
    invoke-virtual/range {v1 .. v6}, Lorg/bouncycastle/crypto/engines/ISAPEngine$ISAPAEAD_K;->ABSORB_MAC([S[BI[S[S)V

    iget-object p1, p0, Lorg/bouncycastle/crypto/engines/ISAPEngine$ISAPAEAD_K;->SX:[S

    invoke-direct {p0, p1, p5, p6}, Lorg/bouncycastle/crypto/engines/ISAPEngine$ISAPAEAD_K;->shortToByte([S[BI)V
...
.method protected thetaRhoPiChiIota([S[S[S)V
    ...
    invoke-direct {v0, v8, v1}, Lorg/bouncycastle/crypto/engines/ISAPEngine$ISAPAEAD_K;->ROL16(SI)S
    ...
    invoke-direct {v0, v3, v12}, Lorg/bouncycastle/crypto/engines/ISAPEngine$ISAPAEAD_K;->ROL16(SI)S
...
.method protected thetaRhoPiChiIotaPrepareTheta(I[S[S[S)V
    ...
    aput-short v12, p2, v24

    aget-short v12, p2, v24
    ...
    aget-short v14, p4, v4

    aget-short v27, p3, v22
    ...
    aget-short v14, p4, v3

    aget-short v27, p3, v16
    ...
    aget-short v23, p4, v13

    aget-short v27, p3, v15

    xor-int v4, v23, v27

    int-to-short v4, v4

    aput-short v4, p4, v13
    ...
    aget-short v4, p2, v14

    xor-int/2addr v4, v7

    int-to-short v4, v4

    aput-short v4, p2, v14

    aget-short v4, p2, v14

    const/4 v11, 0x6

    invoke-direct {v0, v4, v11}, Lorg/bouncycastle/crypto/engines/ISAPEngine$ISAPAEAD_K;->ROL16(SI)S
    ...
    aget-short v27, p2, v16

    xor-int v8, v27, v2

    int-to-short v8, v8

    aput-short v8, p2, v16

    aget-short v8, p2, v16
    ...
    aput-short v14, p3, v26

    const/4 v14, 0x0

    aget-short v28, p4, v14

    aget-short v29, p3, v26

    xor-int v12, v28, v29

    int-to-short v12, v12

    aput-short v12, p4, v14
    ...
    aget-short v29, p3, v14

    xor-int v12, v12, v29

    int-to-short v12, v12

    aput-short v12, p4, v3
    ...
    invoke-direct {v0, v8, v12}, Lorg/bouncycastle/crypto/engines/ISAPEngine$ISAPAEAD_K;->ROL16(SI)S
    ...
    aput-short v14, p3, v12

    const/4 v14, 0x0

    aget-short v18, p4, v14

    aget-short v19, p3, v12
    ...
    aput-short v1, p3, v17

    const/4 v1, 0x3

    aget-short v8, p4, v1

    aget-short v12, p3, v17
