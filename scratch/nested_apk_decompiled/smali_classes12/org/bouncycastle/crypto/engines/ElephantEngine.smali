...
.method private get_c_block([B[BIII)V
    ...
    invoke-static {p1, v1, p2, v1}, Ljava/util/Arrays;->fill([BIIB)V
    ...
    iget p5, p0, Lorg/bouncycastle/crypto/engines/ElephantEngine;->BLOCK_SIZE:I

    if-gt p5, p4, :cond_1

    iget p4, p0, Lorg/bouncycastle/crypto/engines/ElephantEngine;->BLOCK_SIZE:I
    ...
    invoke-static {p1, p4, p2, v1}, Ljava/util/Arrays;->fill([BIIB)V
...
.method private permutation([B)V
    ...
    iget v2, p0, Lorg/bouncycastle/crypto/engines/ElephantEngine;->nSBox:I
    ...
    :goto_1
    iget v4, p0, Lorg/bouncycastle/crypto/engines/ElephantEngine;->nRounds:I
...
.method public doFinal([BI)I
    ...
    iget-object v5, p0, Lorg/bouncycastle/crypto/engines/ElephantEngine;->inputMessage:[B
    ...
    invoke-direct/range {v4 .. v12}, Lorg/bouncycastle/crypto/engines/ElephantEngine;->processBytes([B[BIIIIII)I
    ...
    :cond_5
    iget p1, p0, Lorg/bouncycastle/crypto/engines/ElephantEngine;->inputOff:I

    iget-byte p2, p0, Lorg/bouncycastle/crypto/engines/ElephantEngine;->CRYPTO_ABYTES:B

    sub-int/2addr p1, p2

    iput p1, p0, Lorg/bouncycastle/crypto/engines/ElephantEngine;->inputOff:I
    ...
    const-string v0, " needs call init function before doFinal"
...
.method public processBytes([BII[BI)I
    ...
    iget-boolean v2, v9, Lorg/bouncycastle/crypto/engines/ElephantEngine;->forEncryption:Z
    ...
    :cond_0
    iget-byte v2, v9, Lorg/bouncycastle/crypto/engines/ElephantEngine;->CRYPTO_ABYTES:B

    :goto_0
    sub-int/2addr v1, v2

    iget v2, v9, Lorg/bouncycastle/crypto/engines/ElephantEngine;->BLOCK_SIZE:I
    ...
    iget-object v1, v9, Lorg/bouncycastle/crypto/engines/ElephantEngine;->inputMessage:[B
