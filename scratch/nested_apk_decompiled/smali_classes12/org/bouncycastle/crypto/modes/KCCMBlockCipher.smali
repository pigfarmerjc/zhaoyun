...
.method private processAAD([BIII)V
    ...
    iget-object p3, p0, Lorg/bouncycastle/crypto/modes/KCCMBlockCipher;->macBlock:[B

    invoke-interface {p1, p2, v4, p3, v4}, Lorg/bouncycastle/crypto/BlockCipher;->processBlock([BI[BI)I
...
.method public processPacket([BII[BI)I
    ...
    iget-object p2, p0, Lorg/bouncycastle/crypto/modes/KCCMBlockCipher;->buffer:[B

    iget v0, p0, Lorg/bouncycastle/crypto/modes/KCCMBlockCipher;->macSize:I

    invoke-static {p4, p1, p2, v1, v0}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
