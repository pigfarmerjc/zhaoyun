...
.method private generateParameters_FIPS186_2()Lorg/bouncycastle/crypto/params/DSAParameters;
    ...
    iget-object v10, v0, Lorg/bouncycastle/crypto/generators/DSAParametersGenerator;->digest:Lorg/bouncycastle/crypto/Digest;

    instance-of v10, v10, Lorg/bouncycastle/crypto/digests/SHA1Digest;
    ...
    invoke-static {v10, v2, v3, v11}, Lorg/bouncycastle/crypto/generators/DSAParametersGenerator;->hash(Lorg/bouncycastle/crypto/Digest;[B[BI)V
    ...
    invoke-static {v10, v4, v4, v11}, Lorg/bouncycastle/crypto/generators/DSAParametersGenerator;->hash(Lorg/bouncycastle/crypto/Digest;[B[BI)V
    ...
    invoke-static {v15, v12, v9, v1}, Lorg/bouncycastle/crypto/generators/DSAParametersGenerator;->hash(Lorg/bouncycastle/crypto/Digest;[B[BI)V
    ...
    invoke-static {v14, v12, v3, v11}, Lorg/bouncycastle/crypto/generators/DSAParametersGenerator;->hash(Lorg/bouncycastle/crypto/Digest;[B[BI)V

    rsub-int/lit8 v14, v1, 0x14

    invoke-static {v3, v14, v9, v11, v1}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
    ...
    invoke-direct {v1, v7, v9}, Ljava/math/BigInteger;-><init>(I[B)V
    ...
    invoke-static {v1, v10, v3}, Lorg/bouncycastle/crypto/generators/DSAParametersGenerator;->calculateGenerator_FIPS186_2(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/security/SecureRandom;)Ljava/math/BigInteger;
...
.method private generateParameters_FIPS186_3()Lorg/bouncycastle/crypto/params/DSAParameters;
    ...
    iget v2, v0, Lorg/bouncycastle/crypto/generators/DSAParametersGenerator;->L:I
    ...
    invoke-virtual {v9, v3}, Ljava/security/SecureRandom;->nextBytes([B)V

    const/4 v9, 0x0

    invoke-static {v1, v3, v8, v9}, Lorg/bouncycastle/crypto/generators/DSAParametersGenerator;->hash(Lorg/bouncycastle/crypto/Digest;[B[BI)V
    ...
    invoke-virtual {v10, v11}, Ljava/math/BigInteger;->setBit(I)Ljava/math/BigInteger;
    ...
    invoke-static {v1, v11, v6, v15}, Lorg/bouncycastle/crypto/generators/DSAParametersGenerator;->hash(Lorg/bouncycastle/crypto/Digest;[B[BI)V
    ...
    invoke-static {v1, v11, v8, v9}, Lorg/bouncycastle/crypto/generators/DSAParametersGenerator;->hash(Lorg/bouncycastle/crypto/Digest;[B[BI)V

    sub-int v15, v7, v14

    invoke-static {v8, v15, v6, v9, v14}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
    ...
    invoke-direct {v14, v5, v6}, Ljava/math/BigInteger;-><init>(I[B)V
    ...
    :cond_3
    invoke-direct {v0, v5}, Lorg/bouncycastle/crypto/generators/DSAParametersGenerator;->isProbablePrime(Ljava/math/BigInteger;)Z
    ...
    invoke-static {v1, v5, v10, v3, v2}, Lorg/bouncycastle/crypto/generators/DSAParametersGenerator;->calculateGenerator_FIPS186_3_Verifiable(Lorg/bouncycastle/crypto/Digest;Ljava/math/BigInteger;Ljava/math/BigInteger;[BI)Ljava/math/BigInteger;
    ...
    invoke-direct {v4, v3, v13, v6}, Lorg/bouncycastle/crypto/params/DSAValidationParameters;-><init>([BII)V

    invoke-direct {v2, v5, v10, v1, v4}, Lorg/bouncycastle/crypto/params/DSAParameters;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Lorg/bouncycastle/crypto/params/DSAValidationParameters;)V
    ...
    invoke-static {v5, v10, v1}, Lorg/bouncycastle/crypto/generators/DSAParametersGenerator;->calculateGenerator_FIPS186_3_Unverifiable(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/security/SecureRandom;)Ljava/math/BigInteger;
