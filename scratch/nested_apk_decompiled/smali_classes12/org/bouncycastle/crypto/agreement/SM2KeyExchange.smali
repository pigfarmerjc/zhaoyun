...
.method private kdf(Lorg/bouncycastle/math/ec/ECPoint;[B[BI)[B
    ...
    instance-of v4, v4, Lorg/bouncycastle/util/Memoable;
    ...
    invoke-direct {p0, v4, v6}, Lorg/bouncycastle/crypto/agreement/SM2KeyExchange;->addFieldElement(Lorg/bouncycastle/crypto/Digest;Lorg/bouncycastle/math/ec/ECFieldElement;)V
    ...
    invoke-interface {v4, p2, v5, v6}, Lorg/bouncycastle/crypto/Digest;->update([BII)V

    iget-object v4, p0, Lorg/bouncycastle/crypto/agreement/SM2KeyExchange;->digest:Lorg/bouncycastle/crypto/Digest;

    array-length v6, p3

    invoke-interface {v4, p3, v5, v6}, Lorg/bouncycastle/crypto/Digest;->update([BII)V
    ...
    invoke-interface {v4, v6}, Lorg/bouncycastle/util/Memoable;->reset(Lorg/bouncycastle/util/Memoable;)V
    ...
    invoke-interface {v9, p2, v5, v10}, Lorg/bouncycastle/crypto/Digest;->update([BII)V

    iget-object v9, p0, Lorg/bouncycastle/crypto/agreement/SM2KeyExchange;->digest:Lorg/bouncycastle/crypto/Digest;

    array-length v10, p3

    invoke-interface {v9, p3, v5, v10}, Lorg/bouncycastle/crypto/Digest;->update([BII)V

    :goto_2
    add-int/lit8 v8, v8, 0x1

    invoke-static {v8, v2, v5}, Lorg/bouncycastle/util/Pack;->intToBigEndian(I[BI)V

    iget-object v9, p0, Lorg/bouncycastle/crypto/agreement/SM2KeyExchange;->digest:Lorg/bouncycastle/crypto/Digest;

    invoke-interface {v9, v2, v5, v1}, Lorg/bouncycastle/crypto/Digest;->update([BII)V

    iget-object v9, p0, Lorg/bouncycastle/crypto/agreement/SM2KeyExchange;->digest:Lorg/bouncycastle/crypto/Digest;

    invoke-interface {v9, v2, v5}, Lorg/bouncycastle/crypto/Digest;->doFinal([BI)I
    ...
    invoke-static {v2, v5, v3, v7, v9}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
