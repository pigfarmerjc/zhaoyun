...
.method public static final commonAsUtf8ToByteArray(Ljava/lang/String;)[B
    ...
    invoke-static {v13, v6}, Lkotlin/jvm/internal/Intrinsics;->compare(II)I
...
.method public static final commonToUtf8String([BII)Ljava/lang/String;
    ...
    .local v7, "$this$processUtf16Chars$iv":[B
    const/4 v8, 0x0

    .line 61
    .local v8, "$i$f$processUtf16Chars":I
    move v9, v6
    ...
    .line 35
    .local v12, "$i$a$-processUtf16Chars-_Utf8Kt$commonToUtf8String$1":I
    ...
    .line 67
    .end local v10    # "c":C
    .end local v12    # "$i$a$-processUtf16Chars-_Utf8Kt$commonToUtf8String$1":I
    nop
    ...
    .end local v13    # "$this$shr$iv$iv":B
    ...
    .local v13, "beginIndex$iv$iv":I
    move-object/from16 v17, v7

    .local v17, "$this$process2Utf8Bytes$iv$iv":[B
    const/16 v18, 0x0

    .line 79
    .local v18, "$i$f$process2Utf8Bytes":I
    ...
    .line 35
    .local v19, "$i$a$-processUtf16Chars-_Utf8Kt$commonToUtf8String$1":I
    ...
    .line 78
    .end local v15    # "c":C
    .end local v19    # "$i$a$-processUtf16Chars-_Utf8Kt$commonToUtf8String$1":I
    nop
    ...
    aget-byte v10, v17, v20

    .line 87
    .local v10, "b1$iv$iv":B
    move/from16 v20, v10

    .local v20, "byte$iv$iv$iv":B
    const/16 v22, 0x0
    ...
    .local v24, "$this$and$iv$iv$iv$iv":B
    const/16 v25, 0x0
    ...
    .end local v24    # "$this$and$iv$iv$iv$iv":B
    ...
    .line 78
    .restart local v14    # "$i$a$-process2Utf8Bytes-Utf8$processUtf16Chars$1$iv":I
    move/from16 v20, v8

    .end local v8    # "$i$f$processUtf16Chars":I
    .local v20, "$i$f$processUtf16Chars":I
    int-to-char v8, v6
    ...
    .line 35
    .restart local v19    # "$i$a$-processUtf16Chars-_Utf8Kt$commonToUtf8String$1":I
    ...
    .line 96
    .end local v20    # "$i$f$processUtf16Chars":I
    ...
    .line 97
    .end local v8    # "$i$f$processUtf16Chars":I
    .restart local v20    # "$i$f$processUtf16Chars":I
    nop

    .line 96
    xor-int/lit16 v6, v10, 0xf80
    ...
    .end local v10    # "b1$iv$iv":B
    .local v22, "b1$iv$iv":B
    int-to-char v10, v8
    ...
    .line 78
    .local v10, "$i$a$-process2Utf8Bytes-Utf8$processUtf16Chars$1$iv":I
    int-to-char v14, v8
    ...
    .line 35
    .restart local v16    # "$i$a$-processUtf16Chars-_Utf8Kt$commonToUtf8String$1":I
    add-int/lit8 v21, v4, 0x1
    ...
    .end local v8    # "it$iv":I
    .end local v10    # "$i$a$-process2Utf8Bytes-Utf8$processUtf16Chars$1$iv":I
    sget-object v4, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
    ...
    .line 78
    .end local v6    # "codePoint$iv$iv":I
    .end local v12    # "endIndex$iv$iv":I
    .end local v13    # "beginIndex$iv$iv":I
    .end local v15    # "b0$iv$iv":B
    .end local v17    # "$this$process2Utf8Bytes$iv$iv":[B
    .end local v18    # "$i$f$process2Utf8Bytes":I
    .end local v22    # "b1$iv$iv":B
    :goto_4
    ...
    .restart local v13    # "beginIndex$iv$iv":I
    move-object v15, v7

    .local v15, "$this$process3Utf8Bytes$iv$iv":[B
    const/16 v17, 0x0

    .line 113
    .local v17, "$i$f$process3Utf8Bytes":I
    ...
    .restart local v23    # "byte$iv$iv$iv":B
    const/16 v24, 0x0

    .line 134
    .restart local v24    # "$i$f$isUtf8Continuation":I
    const/16 v25, 0xc0

    .restart local v25    # "other$iv$iv$iv$iv":I
    move/from16 v27, v23

    .restart local v27    # "$this$and$iv$iv$iv$iv":B
    const/16 v28, 0x0
    ...
    .line 112
    .local v14, "$i$a$-process3Utf8Bytes-Utf8$processUtf16Chars$2$iv":I
    move/from16 v23, v6

    .end local v6    # "endIndex$iv$iv":I
    .local v23, "endIndex$iv$iv":I
    int-to-char v6, v10
    ...
    .end local v10    # "it$iv":I
    .end local v14    # "$i$a$-process3Utf8Bytes-Utf8$processUtf16Chars$2$iv":I
    sget-object v4, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
    ...
    .end local v23    # "endIndex$iv$iv":I
    .restart local v4    # "length":I
    .local v6, "endIndex$iv$iv":I
    :cond_e
    move/from16 v23, v6
    ...
    .line 142
    .end local v6    # "endIndex$iv$iv":I
    .restart local v23    # "endIndex$iv$iv":I
    nop
    ...
    .line 112
    .restart local v14    # "$i$a$-process3Utf8Bytes-Utf8$processUtf16Chars$2$iv":I
    move/from16 v24, v8

    .end local v8    # "b2$iv$iv":B
    .local v24, "b2$iv$iv":B
    int-to-char v8, v10
    ...
    .line 112
    .end local v6    # "codePoint$iv$iv":I
    .end local v12    # "b0$iv$iv":B
    .end local v13    # "beginIndex$iv$iv":I
    .end local v15    # "$this$process3Utf8Bytes$iv$iv":[B
    .end local v17    # "$i$f$process3Utf8Bytes":I
    .end local v19    # "length":I
    .end local v23    # "endIndex$iv$iv":I
    .end local v24    # "b2$iv$iv":B
    .local v22, "length":I
    ...
    .local v10, "$this$process4Utf8Bytes$iv$iv":[B
    const/4 v12, 0x0

    .line 162
    .local v12, "$i$f$process4Utf8Bytes":I
    ...
    .line 165
    .local v23, "$i$a$-process4Utf8Bytes-Utf8$processUtf16Chars$3$iv":I
    ...
    .end local v13    # "codePoint$iv":I
    .end local v23    # "$i$a$-process4Utf8Bytes-Utf8$processUtf16Chars$3$iv":I
    sget-object v4, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
    ...
    .local v17, "$this$and$iv$iv$iv$iv":B
    const/16 v23, 0x0
    ...
    .end local v17    # "$this$and$iv$iv$iv$iv":B
    .end local v23    # "$i$f$and":I
    const/16 v4, 0x80

    .end local v4    # "byte$iv$iv$iv":B
    .local v17, "byte$iv$iv$iv":B
    ...
    .restart local v14    # "other$iv$iv$iv$iv":I
    move/from16 v17, v4
    ...
    .line 191
    .local v23, "b1$iv$iv":B
    move/from16 v24, v23

    .local v24, "byte$iv$iv$iv":B
    const/16 v25, 0x0
    ...
    .local v24, "endIndex$iv":I
    if-eq v14, v5, :cond_1c

    .line 170
    ushr-int/lit8 v5, v14, 0xa
    ...
    .line 35
    .local v5, "$i$a$-processUtf16Chars-_Utf8Kt$commonToUtf8String$1":I
    ...
    .line 172
    .end local v4    # "c":C
    .end local v5    # "$i$a$-processUtf16Chars-_Utf8Kt$commonToUtf8String$1":I
    goto :goto_12
    ...
    .end local v5    # "endIndex$iv":I
    .restart local v24    # "endIndex$iv":I
    ...
    .restart local v28    # "$this$and$iv$iv$iv$iv":B
    const/16 v29, 0x0
    ...
    .end local v7    # "$this$processUtf16Chars$iv":[B
    .local v25, "$this$processUtf16Chars$iv":[B
    if-ne v6, v7, :cond_1e
    ...
    .line 165
    .local v7, "$i$a$-process4Utf8Bytes-Utf8$processUtf16Chars$3$iv":I
    const v14, 0xfffd

    if-eq v6, v14, :cond_1f

    .line 170
    ushr-int/lit8 v14, v6, 0xa
    ...
    .end local v7    # "$i$a$-process4Utf8Bytes-Utf8$processUtf16Chars$3$iv":I
    sget-object v4, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
    ...
    .end local v7    # "byte$iv$iv$iv":B
    .local v19, "byte$iv$iv$iv":B
    ...
    .end local v5    # "b2$iv$iv":B
    .local v18, "b2$iv$iv":B
    ...
    .restart local v5    # "codePoint$iv":I
    const/4 v14, 0x0

    .line 165
    .restart local v14    # "$i$a$-process4Utf8Bytes-Utf8$processUtf16Chars$3$iv":I
    const v15, 0xfffd
    ...
    .end local v7    # "codePoint$iv$iv":I
    .end local v8    # "beginIndex$iv$iv":I
    .end local v10    # "$this$process4Utf8Bytes$iv$iv":[B
    .end local v12    # "$i$f$process4Utf8Bytes":I
    .end local v13    # "b0$iv$iv":B
    .end local v15    # "length":I
    .end local v18    # "b2$iv$iv":B
    .end local v23    # "b1$iv$iv":B
    .end local v30    # "endIndex$iv$iv":I
    .restart local v17    # "length":I
    :goto_1d
    add-int/2addr v9, v15
    ...
    .end local v17    # "length":I
    .end local v24    # "endIndex$iv":I
    .end local v25    # "$this$processUtf16Chars$iv":[B
    .restart local v4    # "length":I
    .local v5, "endIndex$iv":I
    .local v7, "$this$processUtf16Chars$iv":[B
    :cond_2c
    ...
    .end local v7    # "$this$processUtf16Chars$iv":[B
    .restart local v24    # "endIndex$iv":I
    .restart local v25    # "$this$processUtf16Chars$iv":[B
    const v5, 0xfffd
    ...
    .line 35
    .local v6, "$i$a$-processUtf16Chars-_Utf8Kt$commonToUtf8String$1":I
    ...
    .line 233
    .end local v5    # "c":C
    .end local v6    # "$i$a$-processUtf16Chars-_Utf8Kt$commonToUtf8String$1":I
    nop
