...
.method public static final collectRecursively(Lkotlin/sequences/SequenceScope;Lokio/FileSystem;Lkotlin/collections/ArrayDeque;Lokio/Path;ZZLkotlin/coroutines/Continuation;)Ljava/lang/Object;
    .locals 17
    .param p0, "$this$collectRecursively"    # Lkotlin/sequences/SequenceScope;
    .param p1, "fileSystem"    # Lokio/FileSystem;
    .param p2, "stack"    # Lkotlin/collections/ArrayDeque;
    .param p3, "path"    # Lokio/Path;
    .param p4, "followSymlinks"    # Z
    .param p5, "postorder"    # Z
    ...
    :goto_0
    iget-object v5, v4, Lokio/internal/-FileSystem$collectRecursively$1;->result:Ljava/lang/Object;
    ...
    .line 107
    iget v7, v4, Lokio/internal/-FileSystem$collectRecursively$1;->label:I
    ...
    :pswitch_0
    iget-boolean v2, v4, Lokio/internal/-FileSystem$collectRecursively$1;->Z$1:Z

    .end local p5    # "postorder":Z
    .local v2, "postorder":Z
    iget-boolean v6, v4, Lokio/internal/-FileSystem$collectRecursively$1;->Z$0:Z

    .end local p4    # "followSymlinks":Z
    .local v6, "followSymlinks":Z
    iget-object v7, v4, Lokio/internal/-FileSystem$collectRecursively$1;->L$4:Ljava/lang/Object;

    check-cast v7, Ljava/util/List;

    .local v7, "children":Ljava/util/List;
    iget-object v8, v4, Lokio/internal/-FileSystem$collectRecursively$1;->L$3:Ljava/lang/Object;

    move-object v1, v8

    check-cast v1, Lokio/Path;

    .end local p3    # "path":Lokio/Path;
    ...
    .local v0, "$this$collectRecursively":Lkotlin/sequences/SequenceScope;
    invoke-static {v5}, Lkotlin/ResultKt;->throwOnFailure(Ljava/lang/Object;)V

    goto/16 :goto_a

    .end local v0    # "$this$collectRecursively":Lkotlin/sequences/SequenceScope;
    .end local v1    # "path":Lokio/Path;
    .end local v2    # "postorder":Z
    .end local v6    # "followSymlinks":Z
    .end local v7    # "children":Ljava/util/List;
    .end local v8    # "stack":Lkotlin/collections/ArrayDeque;
    .end local v9    # "fileSystem":Lokio/FileSystem;
    .restart local p0    # "$this$collectRecursively":Lkotlin/sequences/SequenceScope;
    .restart local p1    # "fileSystem":Lokio/FileSystem;
    .restart local p2    # "stack":Lkotlin/collections/ArrayDeque;
    .restart local p3    # "path":Lokio/Path;
    .restart local p4    # "followSymlinks":Z
    .restart local p5    # "postorder":Z
    :pswitch_1
    iget v7, v4, Lokio/internal/-FileSystem$collectRecursively$1;->I$0:I

    .local v7, "symlinkCount":I
    iget-boolean v2, v4, Lokio/internal/-FileSystem$collectRecursively$1;->Z$1:Z

    .end local p5    # "postorder":Z
    .restart local v2    # "postorder":Z
    iget-boolean v9, v4, Lokio/internal/-FileSystem$collectRecursively$1;->Z$0:Z

    .end local p4    # "followSymlinks":Z
    .local v9, "followSymlinks":Z
    iget-object v10, v4, Lokio/internal/-FileSystem$collectRecursively$1;->L$7:Ljava/lang/Object;

    check-cast v10, Lokio/Path;

    .local v10, "child":Lokio/Path;
    iget-object v11, v4, Lokio/internal/-FileSystem$collectRecursively$1;->L$6:Ljava/lang/Object;

    check-cast v11, Ljava/util/Iterator;

    iget-object v12, v4, Lokio/internal/-FileSystem$collectRecursively$1;->L$5:Ljava/lang/Object;

    check-cast v12, Lokio/Path;

    .local v12, "symlinkPath":Lokio/Path;
    iget-object v13, v4, Lokio/internal/-FileSystem$collectRecursively$1;->L$4:Ljava/lang/Object;

    check-cast v13, Ljava/util/List;

    .local v13, "children":Ljava/util/List;
    iget-object v14, v4, Lokio/internal/-FileSystem$collectRecursively$1;->L$3:Ljava/lang/Object;
    ...
    .end local p3    # "path":Lokio/Path;
    .restart local v1    # "path":Lokio/Path;
    iget-object v14, v4, Lokio/internal/-FileSystem$collectRecursively$1;->L$2:Ljava/lang/Object;

    check-cast v14, Lkotlin/collections/ArrayDeque;

    .end local p2    # "stack":Lkotlin/collections/ArrayDeque;
    .local v14, "stack":Lkotlin/collections/ArrayDeque;
    iget-object v15, v4, Lokio/internal/-FileSystem$collectRecursively$1;->L$1:Ljava/lang/Object;

    check-cast v15, Lokio/FileSystem;

    .end local p1    # "fileSystem":Lokio/FileSystem;
    .local v15, "fileSystem":Lokio/FileSystem;
    iget-object v8, v4, Lokio/internal/-FileSystem$collectRecursively$1;->L$0:Ljava/lang/Object;

    check-cast v8, Lkotlin/sequences/SequenceScope;

    .end local p0    # "$this$collectRecursively":Lkotlin/sequences/SequenceScope;
    .local v8, "$this$collectRecursively":Lkotlin/sequences/SequenceScope;
    :try_start_0
    invoke-static {v5}, Lkotlin/ResultKt;->throwOnFailure(Ljava/lang/Object;)V
    :try_end_0
    ...
    .line 138
    .end local v10    # "child":Lokio/Path;
    :catchall_0
    move-exception v0
    ...
    .end local v1    # "path":Lokio/Path;
    .end local v2    # "postorder":Z
    .end local v7    # "symlinkCount":I
    .end local v8    # "$this$collectRecursively":Lkotlin/sequences/SequenceScope;
    .end local v9    # "followSymlinks":Z
    ...
    .end local v15    # "fileSystem":Lokio/FileSystem;
    .restart local p0    # "$this$collectRecursively":Lkotlin/sequences/SequenceScope;
    .restart local p1    # "fileSystem":Lokio/FileSystem;
    .restart local p2    # "stack":Lkotlin/collections/ArrayDeque;
    .restart local p3    # "path":Lokio/Path;
    ...
    .end local p5    # "postorder":Z
    .restart local v2    # "postorder":Z
    iget-boolean v7, v4, Lokio/internal/-FileSystem$collectRecursively$1;->Z$0:Z

    .end local p4    # "followSymlinks":Z
    .local v7, "followSymlinks":Z
    iget-object v8, v4, Lokio/internal/-FileSystem$collectRecursively$1;->L$3:Ljava/lang/Object;
    ...
    .end local p0    # "$this$collectRecursively":Lkotlin/sequences/SequenceScope;
    .restart local v0    # "$this$collectRecursively":Lkotlin/sequences/SequenceScope;
    invoke-static {v5}, Lkotlin/ResultKt;->throwOnFailure(Ljava/lang/Object;)V
    ...
    iput-boolean v9, v4, Lokio/internal/-FileSystem$collectRecursively$1;->Z$0:Z
    ...
    .restart local v1    # "path":Lokio/Path;
    .restart local v2    # "postorder":Z
    .restart local v7    # "followSymlinks":Z
    ...
    .end local p4    # "followSymlinks":Z
    .end local p5    # "postorder":Z
    .local v1, "$this$collectRecursively":Lkotlin/sequences/SequenceScope;
    .local v2, "path":Lokio/Path;
    .restart local v7    # "followSymlinks":Z
    .restart local v8    # "stack":Lkotlin/collections/ArrayDeque;
    .restart local v9    # "fileSystem":Lokio/FileSystem;
    .local v11, "postorder":Z
    :goto_2
    invoke-virtual {v9, v2}, Lokio/FileSystem;->listOrNull(Lokio/Path;)Ljava/util/List;
    ...
    .line 120
    .restart local v13    # "children":Ljava/util/List;
    move-object v0, v13
    ...
    .line 123
    .local v0, "symlinkPath":Lokio/Path;
    const/4 v12, 0x0

    move-object v14, v0

    .line 124
    .end local v0    # "symlinkPath":Lokio/Path;
    .local v12, "symlinkCount":I
    .local v14, "symlinkPath":Lokio/Path;
    :goto_3
    nop
    ...
    invoke-virtual {v8, v14}, Lkotlin/collections/ArrayDeque;->contains(Ljava/lang/Object;)Z
    ...
    const-string v10, "symlink cycle at "
    ...
    .line 132
    :cond_6
    invoke-virtual {v8, v14}, Lkotlin/collections/ArrayDeque;->addLast(Ljava/lang/Object;)V
    ...
    .local v12, "symlinkPath":Lokio/Path;
    .local v14, "stack":Lkotlin/collections/ArrayDeque;
    .restart local v15    # "fileSystem":Lokio/FileSystem;
    :goto_5
    :try_start_2
    ...
    iput-object v15, v4, Lokio/internal/-FileSystem$collectRecursively$1;->L$1:Ljava/lang/Object;

    iput-object v14, v4, Lokio/internal/-FileSystem$collectRecursively$1;->L$2:Ljava/lang/Object;
    ...
    iput-object v11, v4, Lokio/internal/-FileSystem$collectRecursively$1;->L$6:Ljava/lang/Object;
    ...
    iput v7, v4, Lokio/internal/-FileSystem$collectRecursively$1;->I$0:I
    ...
    .restart local v10    # "child":Lokio/Path;
    :goto_7
    const/4 v10, 0x1
    ...
    .end local v14    # "symlinkPath":Lokio/Path;
    :cond_b
    move-object v0, v1
    ...
    iput-boolean v6, v4, Lokio/internal/-FileSystem$collectRecursively$1;->Z$0:Z
