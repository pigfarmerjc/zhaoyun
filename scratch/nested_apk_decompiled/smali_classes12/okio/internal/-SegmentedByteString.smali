...
.method public static final commonCopyInto(Lokio/SegmentedByteString;I[BII)V
    ...
    invoke-static {v8, v7}, Lokio/internal/-SegmentedByteString;->segment(Lokio/SegmentedByteString;I)I
    ...
    .line 220
    .local v17, "$i$a$-forEachSegment--SegmentedByteString$commonCopyInto$1":I
    move/from16 v21, v0
    ...
    invoke-static {v3, v1, v12, v0, v2}, Lkotlin/collections/ArraysKt;->copyInto([B[BIII)[B
    ...
    .end local v3    # "data":[B
    .end local v17    # "$i$a$-forEachSegment--SegmentedByteString$commonCopyInto$1":I
    ...
    .end local v14    # "segmentSize$iv":I
    .end local v15    # "byteCount$iv":I
    .end local v16    # "offset$iv":I
    .end local v21    # "segmentPos$iv":I
...
.method public static final commonRangeEquals(Lokio/SegmentedByteString;ILokio/ByteString;II)Z
    ...
    invoke-static {v7, v6}, Lokio/internal/-SegmentedByteString;->segment(Lokio/SegmentedByteString;I)I
    ...
    .line 183
    .local v17, "$i$a$-forEachSegment--SegmentedByteString$commonRangeEquals$1":I
    move/from16 v4, v18
    ...
    .local v2, "data":[B
    .local v4, "offset":I
    .local v18, "$i$f$commonRangeEquals":I
    invoke-virtual {v1, v11, v2, v4, v0}, Lokio/ByteString;->rangeEquals(I[BII)Z
    ...
    .end local v17    # "$i$a$-forEachSegment--SegmentedByteString$commonRangeEquals$1":I
    nop
    ...
    .line 291
    .end local v18    # "$i$f$commonRangeEquals":I
    .local v2, "$i$f$commonRangeEquals":I
    :cond_3
    nop
    ...
    .restart local v18    # "$i$f$commonRangeEquals":I
    :goto_2
    const/4 v0, 0x0
...
.method public static final commonRangeEquals(Lokio/SegmentedByteString;I[BII)Z
    ...
    .line 203
    .local v18, "$i$a$-forEachSegment--SegmentedByteString$commonRangeEquals$2":I
    move/from16 v0, v19
    ...
    .local v3, "data":[B
    .local v19, "$i$f$commonRangeEquals":I
    invoke-static {v3, v0, v1, v12, v2}, Lokio/-SegmentedByteString;->arrayRangeEquals([BI[BII)Z
    ...
    .end local v3    # "data":[B
    .end local v18    # "$i$a$-forEachSegment--SegmentedByteString$commonRangeEquals$2":I
    nop
    ...
    .line 305
    .end local v19    # "$i$f$commonRangeEquals":I
    .local v3, "$i$f$commonRangeEquals":I
    :cond_3
    nop
    ...
    .line 196
    .end local v12    # "otherOffset":I
    :cond_4
    move/from16 v19, v3

    .end local v3    # "$i$f$commonRangeEquals":I
    .restart local v19    # "$i$f$commonRangeEquals":I
    goto :goto_2

    .line 195
    .end local v19    # "$i$f$commonRangeEquals":I
    .restart local v3    # "$i$f$commonRangeEquals":I
    :cond_5
    move/from16 v19, v3
...
.method public static final commonWrite(Lokio/SegmentedByteString;Lokio/Buffer;II)V
    ...
    invoke-static {v6, v5}, Lokio/internal/-SegmentedByteString;->segment(Lokio/SegmentedByteString;I)I
    ...
    .restart local v16    # "segment":Lokio/Segment;
    :cond_1
    move-object/from16 v2, v16

    .end local v16    # "segment":Lokio/Segment;
    .restart local v2    # "segment":Lokio/Segment;
    ...
    .line 277
    .end local v18    # "$i$f$commonWrite":I
    .local v2, "$i$f$commonWrite":I
    :cond_2
    move/from16 v18, v2
