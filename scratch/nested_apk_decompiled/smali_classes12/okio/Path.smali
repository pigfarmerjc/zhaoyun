...
.method public static final get(Ljava/nio/file/Path;)Lokio/Path;
    .locals 1
    .param p0, "$this$get"    # Ljava/nio/file/Path;
    .annotation runtime Lkotlin/jvm/JvmStatic;
    .end annotation
...
.method public compareTo(Lokio/Path;)I
    ...
    .local v0, "other$iv":Lokio/Path;
    move-object v1, p0

    .local v1, "$this$commonCompareTo$iv":Lokio/Path;
    const/4 v2, 0x0
    ...
    invoke-virtual {v3, v4}, Lokio/ByteString;->compareTo(Lokio/ByteString;)I

    move-result v0

    .line 104
    .end local v0    # "other$iv":Lokio/Path;
    .end local v1    # "$this$commonCompareTo$iv":Lokio/Path;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    .local v1, "$this$commonEquals$iv":Lokio/Path;
    const/4 v2, 0x0

    .line 307
    .local v2, "$i$f$commonEquals":I
    instance-of v3, v0, Lokio/Path;
    ...
    invoke-virtual {v3}, Lokio/Path;->getBytes$okio()Lokio/ByteString;
    ...
    .end local v1    # "$this$commonEquals$iv":Lokio/Path;
...
.method public final relativeTo(Lokio/Path;)Lokio/Path;
    ...
    .local v1, "$this$commonRelativeTo$iv":Lokio/Path;
    const/4 v2, 0x0

    .line 264
    .local v2, "$i$f$commonRelativeTo":I
    invoke-virtual {v1}, Lokio/Path;->getRoot()Lokio/Path;
    ...
    .line 268
    invoke-virtual {v1}, Lokio/Path;->getSegmentsBytes()Ljava/util/List;

    move-result-object v3

    .line 269
    .local v3, "thisSegments$iv":Ljava/util/List;
    invoke-virtual {v0}, Lokio/Path;->getSegmentsBytes()Ljava/util/List;

    move-result-object v5

    .line 272
    .local v5, "otherSegments$iv":Ljava/util/List;
    const/4 v6, 0x0

    .line 273
    .local v6, "firstNewSegmentIndex$iv":I
    ...
    invoke-static {v4, v10, v8, v9, v11}, Lokio/Path$Companion;->get$default(Lokio/Path$Companion;Ljava/lang/String;ZILjava/lang/Object;)Lokio/Path;
    ...
    invoke-static {v1}, Lokio/internal/-Path;->access$getSlash(Lokio/Path;)Lokio/ByteString;
    ...
    invoke-static {v9}, Lokio/internal/-Path;->access$toSlash(Ljava/lang/String;)Lokio/ByteString;
    ...
    invoke-virtual {v4, v12}, Lokio/Buffer;->write(Lokio/ByteString;)Lokio/Buffer;

    .line 298
    invoke-virtual {v4, v9}, Lokio/Buffer;->write(Lokio/ByteString;)Lokio/Buffer;
    ...
    .end local v10    # "i$iv":I
    :cond_6
    invoke-static {v4, v8}, Lokio/internal/-Path;->toPath(Lokio/Buffer;Z)Lokio/Path;
    ...
    .line 95
    .end local v0    # "other$iv":Lokio/Path;
    .end local v1    # "$this$commonRelativeTo$iv":Lokio/Path;
    .end local v2    # "$i$f$commonRelativeTo":I
    .end local v3    # "thisSegments$iv":Ljava/util/List;
    .end local v4    # "buffer$iv":Lokio/Buffer;
    .end local v5    # "otherSegments$iv":Ljava/util/List;
    .end local v6    # "firstNewSegmentIndex$iv":I
    .end local v7    # "minSegmentsSize$iv":I
    .end local v9    # "slash$iv":Lokio/ByteString;
    :goto_4
    return-object v1

    .line 285
    .restart local v0    # "other$iv":Lokio/Path;
    .restart local v1    # "$this$commonRelativeTo$iv":Lokio/Path;
    .restart local v2    # "$i$f$commonRelativeTo":I
    .restart local v3    # "thisSegments$iv":Ljava/util/List;
    .restart local v5    # "otherSegments$iv":Ljava/util/List;
    .restart local v6    # "firstNewSegmentIndex$iv":I
    .restart local v7    # "minSegmentsSize$iv":I
    :cond_7
    const/4 v8, 0x0

    .line 286
    .local v8, "$i$a$-require--Path$commonRelativeTo$2$iv":I
    ...
    .line 285
    .end local v8    # "$i$a$-require--Path$commonRelativeTo$2$iv":I
    ...
    .line 265
    .local v3, "$i$a$-require--Path$commonRelativeTo$1$iv":I
    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string v6, "Paths of different roots cannot be relative to each other: "
    ...
    .line 264
    .end local v3    # "$i$a$-require--Path$commonRelativeTo$1$iv":I
...
.method public final resolve(Ljava/lang/String;)Lokio/Path;
    ...
    .local v2, "child$iv":Ljava/lang/String;
    const/4 v3, 0x0
    ...
    .local v4, "child$iv$iv":Lokio/Buffer;
    move v5, v0

    .local v5, "normalize$iv$iv":Z
    move-object v6, v1

    .local v6, "$this$commonResolve$iv$iv":Lokio/Path;
    const/4 v7, 0x0

    .line 240
    .local v7, "$i$f$commonResolve":I
    const/4 v8, 0x0
    ...
    invoke-static {v6, v8, v5}, Lokio/internal/-Path;->commonResolve(Lokio/Path;Lokio/Path;Z)Lokio/Path;

    move-result-object v4

    .line 230
    .end local v4    # "child$iv$iv":Lokio/Buffer;
    .end local v5    # "normalize$iv$iv":Z
    .end local v6    # "$this$commonResolve$iv$iv":Lokio/Path;
    .end local v7    # "$i$f$commonResolve":I
    nop

    .line 78
    .end local v0    # "normalize$iv":Z
    .end local v1    # "$this$commonResolve$iv":Lokio/Path;
    .end local v2    # "child$iv":Ljava/lang/String;
...
.method public final resolve(Ljava/lang/String;Z)Lokio/Path;
    ...
    .local v1, "child$iv":Ljava/lang/String;
    move-object v2, p0
    ...
    .line 87
    .end local v0    # "normalize$iv":Z
    .end local v1    # "child$iv":Ljava/lang/String;
...
.method public final resolve(Lokio/ByteString;)Lokio/Path;
    ...
    .local v2, "child$iv":Lokio/ByteString;
    const/4 v3, 0x0
    ...
    invoke-virtual {v4, v2}, Lokio/Buffer;->write(Lokio/ByteString;)Lokio/Buffer;
    ...
    .end local v0    # "normalize$iv":Z
    .end local v1    # "$this$commonResolve$iv":Lokio/Path;
    .end local v2    # "child$iv":Lokio/ByteString;
    .end local v3    # "$i$f$commonResolve":I
    return-object v4
.end method
...
.method public final resolve(Lokio/ByteString;Z)Lokio/Path;
    ...
    .local v1, "child$iv":Lokio/ByteString;
    move-object v2, p0
    ...
    .line 90
    .end local v0    # "normalize$iv":Z
    .end local v1    # "child$iv":Lokio/ByteString;
    .end local v2    # "$this$commonResolve$iv":Lokio/Path;
    .end local v3    # "$i$f$commonResolve":I
    return-object v4
.end method
