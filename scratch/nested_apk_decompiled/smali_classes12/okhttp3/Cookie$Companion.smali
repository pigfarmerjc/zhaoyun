...
.method private final parseExpires(Ljava/lang/String;II)J
    ...
    sget-object v13, Lokhttp3/internal/_UtilJvmKt;->UTC:Ljava/util/TimeZone;
...
.method public final parse$okhttp(JLokhttp3/HttpUrl;Ljava/lang/String;)Lokhttp3/Cookie;
    ...
    invoke-static/range {v2 .. v7}, Lokhttp3/internal/_UtilCommonKt;->delimiterOffset$default(Ljava/lang/String;CIIILjava/lang/Object;)I
    ...
    invoke-static {v8, v4, v2, v5, v3}, Lokhttp3/internal/_UtilCommonKt;->trimSubstring$default(Ljava/lang/String;IIILjava/lang/Object;)Ljava/lang/String;
    ...
    invoke-static {v6}, Lokhttp3/internal/_UtilCommonKt;->indexOfControlOrNonAscii(Ljava/lang/String;)I
    ...
    invoke-static {v8, v0, v10}, Lokhttp3/internal/_UtilCommonKt;->trimSubstring(Ljava/lang/String;II)Ljava/lang/String;

    move-result-object v24

    .line 464
    .local v24, "cookieValue":Ljava/lang/String;
    invoke-static/range {v24 .. v24}, Lokhttp3/internal/_UtilCommonKt;->indexOfControlOrNonAscii(Ljava/lang/String;)I
    ...
    .line 476
    .local v19, "sameSite":Ljava/lang/String;
    ...
    .end local v19    # "sameSite":Ljava/lang/String;
    .end local v20    # "pos":I
    .local v3, "limit":I
    ...
    .local v14, "pos":I
    .local v25, "deltaSeconds":J
    .local v27, "secureOnly":Z
    .local v28, "httpOnly":Z
    .local v29, "hostOnly":Z
    .local v30, "persistent":Z
    .local v31, "sameSite":Ljava/lang/String;
    :goto_1
    if-ge v14, v3, :cond_c
    ...
    invoke-static {v8, v0, v14, v3}, Lokhttp3/internal/_UtilCommonKt;->delimiterOffset(Ljava/lang/String;CII)I
    ...
    invoke-static {v8, v0, v14, v15}, Lokhttp3/internal/_UtilCommonKt;->delimiterOffset(Ljava/lang/String;CII)I

    move-result v4

    .line 482
    .local v4, "attributeEqualsSign":I
    invoke-static {v8, v14, v4}, Lokhttp3/internal/_UtilCommonKt;->trimSubstring(Ljava/lang/String;II)Ljava/lang/String;
    ...
    invoke-static {v8, v0, v15}, Lokhttp3/internal/_UtilCommonKt;->trimSubstring(Ljava/lang/String;II)Ljava/lang/String;
    ...
    .end local v30    # "persistent":Z
    .local v0, "persistent":Z
    goto/16 :goto_4

    .line 495
    .end local v0    # "persistent":Z
    .restart local v30    # "persistent":Z
    :catch_0
    move-exception v0
    ...
    .restart local v25    # "deltaSeconds":J
    .restart local v30    # "persistent":Z
    :catch_2
    move-exception v0
    ...
    .end local v27    # "secureOnly":Z
    .local v0, "secureOnly":Z
    goto :goto_4

    .line 521
    .end local v0    # "secureOnly":Z
    .restart local v27    # "secureOnly":Z
    :cond_9
    ...
    .end local v28    # "httpOnly":Z
    .local v0, "httpOnly":Z
    goto :goto_4

    .line 524
    .end local v0    # "httpOnly":Z
    .restart local v28    # "httpOnly":Z
    :cond_a
    ...
    .line 534
    .end local v32    # "pairEqualsSign":I
    .end local v33    # "limit":I
    .local v2, "pairEqualsSign":I
    .local v3, "limit":I
    :cond_c
    ...
    .end local v2    # "pairEqualsSign":I
    .end local v3    # "limit":I
    .restart local v32    # "pairEqualsSign":I
    .restart local v33    # "limit":I
    ...
    invoke-direct/range {v11 .. v23}, Lokhttp3/Cookie;-><init>(Ljava/lang/String;Ljava/lang/String;JLjava/lang/String;Ljava/lang/String;ZZZZLjava/lang/String;Lkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    .end local v7    # "domain":Ljava/lang/String;
    .end local v24    # "cookieValue":Ljava/lang/String;
    .end local v25    # "deltaSeconds":J
    .end local v27    # "secureOnly":Z
    .end local v28    # "httpOnly":Z
    .end local v29    # "hostOnly":Z
    .end local v30    # "persistent":Z
    .end local v31    # "sameSite":Ljava/lang/String;
    .end local v32    # "pairEqualsSign":I
    .end local v33    # "limit":I
    .end local v34    # "pos":I
    .local v2, "pairEqualsSign":I
...
.method public final parseAll(Lokhttp3/HttpUrl;Lokhttp3/Headers;)Ljava/util/List;
    ...
    .local v2, "$this$unmodifiable$iv":Ljava/util/List;
    const/4 v3, 0x0

    .line 728
    .local v3, "$i$f$unmodifiable":I
    ...
    .end local v2    # "$this$unmodifiable$iv":Ljava/util/List;
    .end local v3    # "$i$f$unmodifiable":I
    goto :goto_2
