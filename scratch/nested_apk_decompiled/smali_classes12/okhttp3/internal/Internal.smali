...
.method public static final buildConnectionPool(Lokhttp3/internal/connection/ConnectionListener;Lokhttp3/internal/concurrent/TaskRunner;)Lokhttp3/ConnectionPool;
    .locals 10
    .param p0, "connectionListener"    # Lokhttp3/internal/connection/ConnectionListener;
...
.method public static final charsetOrUtf8(Lokhttp3/MediaType;)Ljava/nio/charset/Charset;
    .locals 2
    .param p0, "$this$charsetOrUtf8"    # Lokhttp3/MediaType;
...
.method public static final chooseCharset(Lokhttp3/MediaType;)Lkotlin/Pair;
    .locals 6
    .param p0, "$this$chooseCharset"    # Lokhttp3/MediaType;
    ...
    invoke-static {p0, v3, v2, v3}, Lokhttp3/MediaType;->charset$default(Lokhttp3/MediaType;Ljava/nio/charset/Charset;ILjava/lang/Object;)Ljava/nio/charset/Charset;
...
.method public static final effectiveCipherSuites(Lokhttp3/ConnectionSpec;[Ljava/lang/String;)[Ljava/lang/String;
    .locals 2
    .param p0, "$this$effectiveCipherSuites"    # Lokhttp3/ConnectionSpec;
    .param p1, "socketEnabledCipherSuites"    # [Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lokhttp3/CipherSuite$Companion;->getORDER_BY_NAME$okhttp()Ljava/util/Comparator;

    move-result-object v1

    invoke-static {v0, p1, v1}, Lokhttp3/internal/_UtilCommonKt;->intersect([Ljava/lang/String;[Ljava/lang/String;Ljava/util/Comparator;)[Ljava/lang/String;
...
.method public static final getConnection(Lokhttp3/Response;)Lokhttp3/internal/connection/RealConnection;
    .locals 1
    .param p0, "$this$connection"    # Lokhttp3/Response;
...
.method public static final taskRunnerInternal(Lokhttp3/OkHttpClient$Builder;Lokhttp3/internal/concurrent/TaskRunner;)Lokhttp3/OkHttpClient$Builder;
    .locals 1
    .param p0, "$this$taskRunnerInternal"    # Lokhttp3/OkHttpClient$Builder;
    .param p1, "taskRunner"    # Lokhttp3/internal/concurrent/TaskRunner;
