...
.method private final buildRedirectRequest(Lokhttp3/Response;Ljava/lang/String;)Lokhttp3/Request;
    ...
    invoke-static {v1, v2}, Lokhttp3/internal/_UtilJvmKt;->canReuseConnectionFor(Lokhttp3/HttpUrl;Lokhttp3/HttpUrl;)Z
...
.method private final recover(Ljava/io/IOException;Lokhttp3/internal/connection/RealCall;Lokhttp3/Request;)Z
    ...
    .line 149
    :cond_1
    invoke-direct {p0, p1, v0}, Lokhttp3/internal/http/RetryAndFollowUpInterceptor;->isRecoverable(Ljava/io/IOException;Z)Z
...
.method public intercept(Lokhttp3/Interceptor$Chain;)Lokhttp3/Response;
    ...
    invoke-virtual {v4, v5, v8, v0}, Lokhttp3/internal/connection/RealCall;->enterNetworkInterceptorExchange(Lokhttp3/Request;ZLokhttp3/internal/http/RealInterceptorChain;)V
    ...
    check-cast v15, Lokhttp3/Call;

    invoke-virtual {v14, v15, v10, v12}, Lokhttp3/EventListener;->followUpDecision(Lokhttp3/Call;Lokhttp3/Response;Lokhttp3/Request;)V
    :try_end_2
    ...
    invoke-virtual {v15, v12, v10, v2}, Lokhttp3/EventListener;->followUpDecision(Lokhttp3/Call;Lokhttp3/Response;Lokhttp3/Request;)V
    :try_end_3
    ...
    .line 110
    .restart local v0    # "exchange":Lokhttp3/internal/connection/Exchange;
    .local v12, "followUpBody":Lokhttp3/RequestBody;
    return-object v10

    .line 113
    .end local v2    # "followUp":Lokhttp3/Request;
    .end local v12    # "followUpBody":Lokhttp3/RequestBody;
    .restart local v13    # "followUp":Lokhttp3/Request;
    ...
    invoke-virtual {v2, v12, v10, v13}, Lokhttp3/EventListener;->followUpDecision(Lokhttp3/Call;Lokhttp3/Response;Lokhttp3/Request;)V
    :try_end_4
    ...
    invoke-virtual {v2, v12, v10, v15}, Lokhttp3/EventListener;->followUpDecision(Lokhttp3/Call;Lokhttp3/Response;Lokhttp3/Request;)V
    ...
    invoke-direct {v2, v12}, Ljava/net/ProtocolException;-><init>(Ljava/lang/String;)V
    ...
    .end local v8    # "newRoutePlanner":Z
    ...
    .restart local v8    # "newRoutePlanner":Z
    ...
    invoke-direct {v1, v0, v4, v5}, Lokhttp3/internal/http/RetryAndFollowUpInterceptor;->recover(Ljava/io/IOException;Lokhttp3/internal/connection/RealCall;Lokhttp3/Request;)Z
    ...
    invoke-virtual {v12, v13, v0, v2}, Lokhttp3/EventListener;->retryDecision(Lokhttp3/Call;Ljava/io/IOException;Z)V
    ...
    .restart local v2    # "isRecoverable":Z
    move-object/from16 v2, p1
    ...
    invoke-static {v12, v9}, Lokhttp3/internal/_UtilCommonKt;->withSuppressed(Ljava/lang/Exception;Ljava/util/List;)Ljava/lang/Throwable;
