...
.method public final registerPolymorphicSerializer(Lkotlin/reflect/KClass;Lkotlin/reflect/KClass;Lkotlinx/serialization/KSerializer;Z)V
    ...
    .line 197
    .local v5, "$i$a$-getOrPut-SerializersModuleBuilder$registerPolymorphicSerializer$names$1":I
    new-instance v6, Ljava/util/HashMap;

    invoke-direct {v6}, Ljava/util/HashMap;-><init>()V

    .line 273
    .end local v5    # "$i$a$-getOrPut-SerializersModuleBuilder$registerPolymorphicSerializer$names$1":I
    move-object v5, v6
    ...
    .line 201
    .local v3, "previousSerializer":Lkotlinx/serialization/KSerializer;
    if-eqz v3, :cond_3
    ...
    .line 209
    .local v8, "$i$a$-find-SerializersModuleBuilder$registerPolymorphicSerializer$previousClass$1":I
    ...
    .end local v8    # "$i$a$-find-SerializersModuleBuilder$registerPolymorphicSerializer$previousClass$1":I
    :goto_3
    if-eqz v9, :cond_4
    ...
    .line 212
    .local v5, "previousClass":Lkotlin/reflect/KClass;
    if-eqz p4, :cond_7
    ...
    .line 213
    .end local v5    # "previousClass":Lkotlin/reflect/KClass;
    goto :goto_5

    .restart local v5    # "previousClass":Lkotlin/reflect/KClass;
    :cond_7
    ...
    const-string v8, "Multiple polymorphic serializers in a scope of \'"
    ...
    const-string v7, " is registered in the module but no Kotlin class is associated with it."
