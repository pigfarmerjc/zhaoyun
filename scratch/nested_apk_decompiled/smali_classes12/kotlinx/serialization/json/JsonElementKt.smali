...
.method public static final JsonPrimitive(Ljava/lang/Void;)Lkotlinx/serialization/json/JsonNull;
    .locals 1
    .param p0, "value"    # Ljava/lang/Void;
...
.method public static final JsonPrimitive-VKZWuLQ(J)Lkotlinx/serialization/json/JsonPrimitive;
    ...
    invoke-static {v0}, Lkotlinx/serialization/json/JsonElementKt;->JsonUnquotedLiteral(Ljava/lang/String;)Lkotlinx/serialization/json/JsonPrimitive;
...
.method public static final JsonUnquotedLiteral(Ljava/lang/String;)Lkotlinx/serialization/json/JsonPrimitive;
    ...
    const-string v1, "Creating a literal unquoted value of \'null\' is forbidden. If you want to create JSON null literal, use JsonNull object, otherwise, use JsonPrimitive"
...
.method private static final error(Lkotlinx/serialization/json/JsonElement;Ljava/lang/String;)Ljava/lang/Void;
    .locals 3
    .param p0, "$this$error"    # Lkotlinx/serialization/json/JsonElement;
...
.method private static final exceptionToNull(Lkotlin/jvm/functions/Function0;)Ljava/lang/Object;
    ...
    .line 329
    .local v0, "$i$f$exceptionToNull":I
    nop
    ...
    .line 332
    .local v1, "e":Lkotlinx/serialization/json/internal/JsonDecodingException;
    const/4 v2, 0x0

    move-object v1, v2

    .line 329
    .end local v1    # "e":Lkotlinx/serialization/json/internal/JsonDecodingException;
    :goto_0
    return-object v1
.end method
...
.method private static final exceptionToNumberFormatException(Lkotlin/jvm/functions/Function0;)Ljava/lang/Object;
    ...
    .line 337
    .local v0, "$i$f$exceptionToNumberFormatException":I
    nop
    ...
    invoke-virtual {v1}, Lkotlinx/serialization/json/internal/JsonDecodingException;->getMessage()Ljava/lang/String;
...
.method public static final getBoolean(Lkotlinx/serialization/json/JsonPrimitive;)Z
    .locals 3
    .param p0, "$this$boolean"    # Lkotlinx/serialization/json/JsonPrimitive;
    ...
    const-string v2, " does not represent a Boolean"
...
.method public static final getBooleanOrNull(Lkotlinx/serialization/json/JsonPrimitive;)Ljava/lang/Boolean;
    .locals 1
    .param p0, "$this$booleanOrNull"    # Lkotlinx/serialization/json/JsonPrimitive;
...
.method public static final getContentOrNull(Lkotlinx/serialization/json/JsonPrimitive;)Ljava/lang/String;
    .locals 1
    .param p0, "$this$contentOrNull"    # Lkotlinx/serialization/json/JsonPrimitive;
...
.method public static final getDouble(Lkotlinx/serialization/json/JsonPrimitive;)D
    .locals 2
    .param p0, "$this$double"    # Lkotlinx/serialization/json/JsonPrimitive;
...
.method public static final getDoubleOrNull(Lkotlinx/serialization/json/JsonPrimitive;)Ljava/lang/Double;
    .locals 1
    .param p0, "$this$doubleOrNull"    # Lkotlinx/serialization/json/JsonPrimitive;
...
.method public static final getFloat(Lkotlinx/serialization/json/JsonPrimitive;)F
    .locals 1
    .param p0, "$this$float"    # Lkotlinx/serialization/json/JsonPrimitive;
...
.method public static final getFloatOrNull(Lkotlinx/serialization/json/JsonPrimitive;)Ljava/lang/Float;
    .locals 1
    .param p0, "$this$floatOrNull"    # Lkotlinx/serialization/json/JsonPrimitive;
...
.method public static final getInt(Lkotlinx/serialization/json/JsonPrimitive;)I
    .locals 6
    .param p0, "$this$int"    # Lkotlinx/serialization/json/JsonPrimitive;
    ...
    .line 259
    .local v1, "$i$a$-exceptionToNumberFormatException-JsonElementKt$int$result$1":I
    :try_start_0
    ...
    .line 352
    .end local v1    # "$i$a$-exceptionToNumberFormatException-JsonElementKt$int$result$1":I
    nop
    ...
    .line 259
    .end local v0    # "$i$f$exceptionToNumberFormatException":I
    move-wide v0, v2
    ...
    .line 354
    .local v1, "e$iv":Lkotlinx/serialization/json/internal/JsonDecodingException;
    new-instance v2, Ljava/lang/NumberFormatException;
...
.method public static final getIntOrNull(Lkotlinx/serialization/json/JsonPrimitive;)Ljava/lang/Integer;
    .locals 7
    .param p0, "$this$intOrNull"    # Lkotlinx/serialization/json/JsonPrimitive;
    ...
    .line 269
    .local v1, "$i$a$-exceptionToNull-JsonElementKt$intOrNull$result$1":I
    const/4 v2, 0x0
    ...
    .end local v1    # "$i$a$-exceptionToNull-JsonElementKt$intOrNull$result$1":I
    ...
    .line 355
    .end local v1    # "e$iv":Lkotlinx/serialization/json/internal/JsonDecodingException;
    :goto_0
    nop

    .line 269
    .end local v0    # "$i$f$exceptionToNull":I
    if-eqz v1, :cond_2
...
.method public static final getJsonArray(Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonArray;
    .locals 1
    .param p0, "$this$jsonArray"    # Lkotlinx/serialization/json/JsonElement;
...
.method public static final getJsonNull(Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonNull;
    .locals 1
    .param p0, "$this$jsonNull"    # Lkotlinx/serialization/json/JsonElement;
...
.method public static final getJsonObject(Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonObject;
    .locals 1
    .param p0, "$this$jsonObject"    # Lkotlinx/serialization/json/JsonElement;
...
.method public static final getJsonPrimitive(Lkotlinx/serialization/json/JsonElement;)Lkotlinx/serialization/json/JsonPrimitive;
    .locals 1
    .param p0, "$this$jsonPrimitive"    # Lkotlinx/serialization/json/JsonElement;
...
.method public static final getLong(Lkotlinx/serialization/json/JsonPrimitive;)J
    .locals 4
    .param p0, "$this$long"    # Lkotlinx/serialization/json/JsonPrimitive;
    ...
    .line 278
    .local v1, "$i$a$-exceptionToNumberFormatException-JsonElementKt$long$1":I
    :try_start_0
    invoke-static {p0}, Lkotlinx/serialization/json/JsonElementKt;->parseLongImpl(Lkotlinx/serialization/json/JsonPrimitive;)J
    ...
    .line 360
    .end local v1    # "$i$a$-exceptionToNumberFormatException-JsonElementKt$long$1":I
    nop
    ...
    .line 361
    .restart local v0    # "$i$f$exceptionToNumberFormatException":I
    :catch_0
    move-exception v1
...
.method public static final getLongOrNull(Lkotlinx/serialization/json/JsonPrimitive;)Ljava/lang/Long;
    .locals 4
    .param p0, "$this$longOrNull"    # Lkotlinx/serialization/json/JsonPrimitive;
    ...
    .line 284
    .local v1, "$i$a$-exceptionToNull-JsonElementKt$longOrNull$1":I
    :try_start_0
    invoke-static {p0}, Lkotlinx/serialization/json/JsonElementKt;->parseLongImpl(Lkotlinx/serialization/json/JsonPrimitive;)J

    move-result-wide v2

    .end local v1    # "$i$a$-exceptionToNull-JsonElementKt$longOrNull$1":I
...
.method public static final parseLongImpl(Lkotlinx/serialization/json/JsonPrimitive;)J
    .locals 2
    .param p0, "$this$parseLongImpl"    # Lkotlinx/serialization/json/JsonPrimitive;
